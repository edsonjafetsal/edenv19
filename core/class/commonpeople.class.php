...
trait CommonPeople
{
	...
	public function getBannerAddress($htmlkey, $object)
	{
		...
		if (!empty($this->array_options["options_phone_extension"])) {		// For objects that store pro phone into ->phone
			$out .= dol_print_phone($this->array_options["options_phone_extension"], $this->country_code, $contactid, $thirdpartyid, 'AC_TEL', '&nbsp;', 'phone_ext', $langs->trans("PhoneExtensions"));
