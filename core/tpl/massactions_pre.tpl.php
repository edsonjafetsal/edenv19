...
{
	//print "Some proposals do not have a Bulk Email Contact assigned.";
	$langs->load("mails");
	...
	$formmail->withfrom = 1;
	$liste = $langs->trans("AllRecipientSelected", count($arrayofselected)) ."<br>Recipients selected: ". implode(', ', $conts);
