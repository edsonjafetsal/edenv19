 ...
 */
class pdf_PROFORMAINV extends ModelePDFFactures
{
	 /**
	...
	protected function _pagehead(&$pdf, $object, $showaddress, $outputlangs)
	{
		...
		$pdf->SetTextColor(0, 0, 60);
		$pdf->MultiCell($w, 3, "Billing Date"." : ".dol_print_date($object->date, "day", false, $outputlangs)." / ", '', 'C');
