 ...
 */
class pdf_invshipBS extends ModelePDFFactures
{
	 /**
	...
	protected function _pagehead(&$pdf, $object, $showaddress, $outputlangs)
	{
		...
		$pdf->SetXY($posx, $posy);
		$pdf->SetTextColor(0, 0, 60);
		$title = $outputlangs->transnoentities("InvoicePaid");
		...
		$pdf->MultiCell($w, 3,"Invoice Shipping", '', 'R');
		...
		$current_y = $pdf->getY();
		$posy = pdf_writeLinkedObjects($pdf, $object, $outputlangs, $posx, $posy-.5, $w, 3, 'R', $default_font_size);
		...
		if ($showaddress)
		{
			...
			$pdf->RoundedRect($posx, $posy, $widthrecbox, $hautcadre+3, 3, '1111', null, $styles);
			$pdf->SetLineStyle(array('dash'=>0));
			...
			//$pdf->MultiCell($widthrecbox, $hautcadre, "", 0, 'R', 1);
			$styles = array('width' => 0.25, 'cap' => 'butt', 'join' => 'miter', 'dash' => '3,3');		
			$pdf->RoundedRect($posx-16, $posy, $widthrecbox+18, $hautcadre+3, 3, '1111', null, $styles);
			$pdf->SetLineStyle(array('dash'=>0));
			$pdf->SetTextColor(0, 0, 60);
			...
			// Show recipient information
			$pdf->SetFont('', '', $default_font_size - 1.3);
