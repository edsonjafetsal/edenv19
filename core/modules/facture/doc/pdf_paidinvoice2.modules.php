 ...
 */
class pdf_paidinvoice2 extends ModelePDFFactures
{
	 /**
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		$arrayidcontact = $object->getIdContact('internal', 'SALESREPFOLL');
				...
				if (!empty($sale_name))
				{
						...
						$pdf->SetFont('', '', $default_font_size - 1);
						$pdf->writeHTMLCell(190, 3, $this->posxdesc - 1, $tab_top - 1,$langs->trans("SalesRepresentative")." : ".$usertmp->getFullName($langs)." email:".$usertmp->email." Phone:".$usertmp->office_phone, 0, 1);
						//$pdf->MultiCell(190, 3, $langs->trans("SalesRepresentative")." : ".$usertmp->getFullName($langs)." email:".$usertmp->email." Phone:".$usertmp->office_phone,  0, 1);
						$nexY = $pdf->GetY();
						$height_incoterms = $nexY - $tab_top;
				...
				for ($i = 0; $i < $nblines; $i++)
				{
					...
					// number item
					$pdf->SetXY($curX, $curY);
					$pdf->MultiCell($this->posxup - $this->posxtva - 6, 3,  $i + 1, 0, 'C');
	...
	protected function _tableau_versements_header($pdf, $object, $outputlangs, $default_font_size, $tab3_posx, $tab3_top, $tab3_width, $tab3_height)
	{
		...
		$pdf->SetXY($tab3_posx-40, $tab3_top - 4);
		$pdf->MultiCell(60, 3, $title, 0, 'L', 0);

		$pdf->line($tab3_posx-40, $tab3_top, $tab3_posx + $tab3_width-27, $tab3_top);
		...
		$pdf->SetXY($tab3_posx -1, $tab3_top);
		$pdf->MultiCell(20, 3, $outputlangs->transnoentities("Type"), 0, 'L', 0);
		$pdf->SetXY($tab3_posx + 14, $tab3_top);
		$pdf->MultiCell(20, 3, "Num Doc #", 0, 'L', 0);
		$pdf->SetXY($tab3_posx + 33, $tab3_top);
		$pdf->MultiCell(20, 3, "Transaction #", 0, 'L', 0);

		$pdf->line($tab3_posx-40, $tab3_top - 1 + $tab3_height, $tab3_posx + $tab3_width-27, $tab3_top - 1 + $tab3_height);
	...
	protected function _tableau_info(&$pdf, $object, $posy, $outputlangs)
	{
		...
		$pdf->SetXY($posx, $tab_top+17 + $tab_hl);
		$pdf->SetFont('', '', $default_font_size - 3);
