 ...
 */
class pdf_PROTO extends ModelePDFPropales
{
	/**
	...
	protected function _tableau_tot(&$pdf, $object, $deja_regle, $posy, $outputlangs)
	{
		...
		if (empty($conf->global->MAIN_GENERATE_DOCUMENTS_WITHOUT_VAT))
		{
			...
			if (!empty($conf->global->MAIN_GENERATE_DOCUMENTS_WITHOUT_VAT_IFNULL) && $tvaisnull)
			{
				...
				$pdf->SetXY($col1x, $tab2_top+5 + $tab2_hl * $index);
							$pdf->SetFont('', '', $default_font_size -3);
						//		$pdf->MultiCell($col2x+20 - $col1x+21, $tab2_hl, "Except in the state of New Jersey - Country, State, County, Local Duties and Fees ( taxes ) are the responsibility of the receiving party", 'R',  1);
...
$pdf->MultiCell($widthrecbox, $hautcadre+5, "", 0,  'R', 1);
	...
	protected function _pagehead(&$pdf, $object, $showaddress, $outputlangs)
	{
		...
		if ($showaddress)
		{
			...
			$pdf->RoundedRect($posx, $posy, $widthrecbox+90, $hautcadre+2, 3, '1111', null, $styles);
			$pdf->SetLineStyle(array('dash'=>0));
			...
			$pdf->MultiCell($widthrecbox, 5, "Bill To".":", 0, 'L');
