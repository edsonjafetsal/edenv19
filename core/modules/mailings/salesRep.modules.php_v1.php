...
//			$sql .= " AND s.email NOT IN (SELECT email FROM ".MAIN_DB_PREFIX."mailing_cibles WHERE fk_mailing=".$mailing_id.")";
			...
			$sql = "SELECT s.rowid as id, s.email as email, sp.firstname as firstname , sp.lastname  as name, CONCAT(sp.firstname, ' ', sp.lastname )  as nameFull, sp.rowid as fk_contact";
			$sql .= " FROM ".MAIN_DB_PREFIX."societe as s ";
