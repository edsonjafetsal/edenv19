 ...
 */
class pdf_ORDERBS extends ModelePDFCommandes
{
    /**
			...
			if (file_exists($dir))
			{
				...
				if (!empty($conf->incoterm->enabled))
				{
					...
					if ($desc_incoterms)
					{
						...
						$pdf->SetFont('', '', $default_font_size - 1);
						$pdf->writeHTMLCell(190, 3, $this->posxdesc - 1, $tab_top -8, dol_htmlentitiesbr($desc_incoterms), 0, 1);
						global $user;
