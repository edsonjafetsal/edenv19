...
echo $txt;
    ...
    function calculateColumnMetrics()
    {
        ...
        $padding = (double)$this->query->output_page_styles["style_margin_left"] + (double)$this->query->output_page_styles["style_padding_left"] + (double)$this->query->output_page_styles["style_border_left"] ;
        $rpadding = (double)$this->query->output_page_styles["style_margin_right"] + (double)$this->query->output_page_styles["style_padding_right"] + (double)$this->query->output_page_styles["style_border_right"];
...
//
        ...
        $this->page_footer_wrapper_offset = (double)$this->query->output_page_styles["style_border_right"] +
                                            (double)$this->query->output_page_styles["style_margin_right"] +
	                                        (double)$this->query->output_page_styles["style_padding_right"] +
                                            (double)$this->query->output_reportbody_styles["style_padding_right"] +
	                                        (double)$this->query->output_reportbody_styles["style_margin_right"] +
	                                        (double)$this->query->output_reportbody_styles["style_border_right"];
...
//echo "$last_draw_end_y $storeY $background_image ".$p."<BR>";
	...
	{
        //cambio 2byte.es
		$this->reporttitle = sw_translate($this->query->derive_attribute("ReportTitle", "Set Report Title"));
    ...
    function draw_image($file, $x, $y, $w, $h=0, $hidden = false)
    {
        if ( $this->pdfDriver == "tcpdf" )
        {
                //$y = $this->document->GetY();
