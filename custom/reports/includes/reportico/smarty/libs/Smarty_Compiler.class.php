...
class Smarty_Compiler extends Smarty {
    ...
    function _compile_file($resource_name, $source_content, &$compiled_content)
    {
		...
		//PROBLEMA DE ADAPTACIÓN 8.2
		$contenido = file_get_contents('../../templates_c/%%9F^9F6^9F6ABC63%%prepare.tpl.php');
		$prueba = file_exists('../templates_c/%%9F^9F6^9F6ABC63%%prepare.tpl.php');
     /*   if (function_exists("preg_replace_callback")) {
		...
		$compiled_content=str_replace("<td class='swPrpCritTitle'>","<td class='swPrpCritTitle'>"."<?"."php",$compiled_content);
		$compiled_content=str_replace("$loopct++;","$loopct++;?>",$compiled_content);
		$compiled_content=str_replace('$loopct = 0;','<?'.'php'.' $loopct=0 ?>',$compiled_content);
    ...
    function _compile_smarty_ref(&$indexes)
    {
        ...
        if (isset($_max_index) && count_($indexes) > $_max_index) {
