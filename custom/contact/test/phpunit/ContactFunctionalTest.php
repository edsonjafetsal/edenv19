...
/**
 * \file    test/phpunit/ContactFunctionalTest.php
 * \ingroup contact
 ...
 * @package Testcontact
 */
class ContactFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/contact/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('contact/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/contact/admin/about.php');
		$this->authenticate();
		return $this->assertContains('contact/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('contactwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modContact_ContactTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modContact_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
