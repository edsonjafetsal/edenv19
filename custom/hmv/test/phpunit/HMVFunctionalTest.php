...
/**
 * \file    test/phpunit/HMVFunctionalTest.php
 * \ingroup hmv
 ...
 * @package Testhmv
 */
class HMVFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/hmv/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('hmv/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/hmv/admin/about.php');
		$this->authenticate();
		return $this->assertContains('hmv/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('hmvwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modHMV_HMVTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modHMV_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
