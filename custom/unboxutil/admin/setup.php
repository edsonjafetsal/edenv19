...
/**
 * \file    unboxutil/admin/setup.php
 * \ingroup unboxutil
...
$arrayofparameters = array(
	'UNBOXUTIL_MYPARAM1'=>array('css'=>'minwidth200', 'enabled'=>1),
	'UNBOXUTIL_MYPARAM2'=>array('css'=>'minwidth500', 'enabled'=>1)
);
...
print load_fiche_titre($langs->trans($page_name), $linkback, 'object_unboxutil@unboxutil');
...
echo '<span class="opacitymedium">'.$langs->trans("UnboxutilSetupPage").'</span><br><br>';
