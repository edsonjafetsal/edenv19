...
class modnomenclature extends DolibarrModules
{
	...
	function __construct($db)
	{
		...
		$this->tabs = array(
		    'product:+nomenclature:Bill of Materials:nomenclature@nomenclature:$user->rights->nomenclature->read:/nomenclature/nomenclature.php?fk_product=__ID__'
