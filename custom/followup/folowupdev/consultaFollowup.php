...
$query1 .= "where fk_action <> 40 and elementtype like 'propal' ";
...
if ($num > 0) {
	...
	while ($CABECERACO = $cabecerasCO->fetch_assoc()) {
		...
		$query2 .= "where fk_action <> 40 and elementtype like 'propal' ";
		$query2 .= " ";
			...
			'<table class="table table-striped table-hover tablageneral" >
              <thead>
				<tr >
					...
					<td><b><p style="text-align:center;">Contact/Adress </p></b></td>
		...
		while ($filaAlumnos2 = $buscarAlumnos2->fetch_assoc()) {
			...
			if (!is_null($filaAlumnos2['FollowUpDays']) && $filaAlumnos2['FollowUpDays'] != 0) {
				$estiloDays = 'color: #FFFFFF; background-color: #29DE1B; font-weight: bold;';
			} elseif ($filaAlumnos2['FollowUpDays'] == 0) {
				$estiloDays = 'color: #FFFFFF; background-color: #0A0134; font-weight: bold;';
			}
			$test=0;
			...
			if(is_null($filaAlumnos2['FollowUpDays'])){
				...
				'<tr style="text-align:center; ' . $estiloCelda . ' ">
				    <td><p style="text-align:center; "><a href=' . $root_url . '/dolibarrhmv/htdocs/comm/action/card.php?id=' . $CABECERACO['id'] . ' style="color: white;">' . $filaAlumnos2['id'] . '</a></td>
					<td><p style="text-align:center; color: white;">' . $filaAlumnos2['label'] . '</td>
					<td><p style="text-align:center; color: white;">'  . $statusText . '</td>
					<td><p style="text-align:center; color: white;">' . $filaAlumnos2['followdate'] . '</p></td>
					<td><p style="'. $estiloCeldaDays . '">'.$diferenciaDias.'</p></td>
					<td><p style="text-align:center; "><a href=' . $root_url . '/dolibarrhmv/htdocs/societe/card.php?id=' . $CABECERACO['idcustomer'] . ' style="color: white;">' . $filaAlumnos2['customer'] . '</a></td>
					<td><p style="text-align:center; "><a href=' . $root_url . '/dolibarrhmv/htdocs/contact/card.php?id=' . $CABECERACO['idcontact'] . ' style="color: white;">' . $filaAlumnos2['contact'] . '</p></td>
					<td><p style="text-align:center; color: white;"><a href=' . $root_url . '/dolibarrhmv/htdocs/comm/propal/card.php?id=' . $CABECERACO['prid'] . ' style="color: white;">' . $filaAlumnos2['ref'] . '</p></td>
					<td><p style="text-align:center; ">' . $filaAlumnos2['amount'] . '</td>
					<td><p style="text-align:center;  background-color: black;">' . $test . '</td>
					<td><p style="text-align:center; color: white;">' . $filaAlumnos2['email'] . '%</p></td>
					<td><p style="text-align:left; color: white;">' . $filaAlumnos2['phone'] . '</p></td>
					<td><p style="text-align:left; color: white;">' . $filaAlumnos2['phonem'] . '</td>';
				...
				'<tr style="text-align:center; ' . $estiloCelda . '">
					...
					<td><p style="text-align:center; "><a href=' . $root_url . '/dolibarrhmv/htdocs/contact/card.php?id=' . $CABECERACO['idcontact'] . ' style="color: white;">' . $filaAlumnos2['contact'] . '</p></td>
					<td><p style="text-align:center; color: white;"><a href=' . $root_url . '/dolibarrhmv/htdocs/comm/propal/card.php?id=' . $CABECERACO['prid'] . ' style="color: white;">' . $filaAlumnos2['ref'] . '</p></td>
					<td><p style="text-align:center; color: white;">' . $filaAlumnos2['amount'] . '</td>
