...
/**
 * \file    test/phpunit/FollowupFunctionalTest.php
 * \ingroup followup
 ...
 *
 * @package Testfollowup
 */
class FollowupFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/followup/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('followup/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/followup/admin/about.php');
		$this->authenticate();
		return $this->assertContains('followup/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('followupwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modFollowup_FollowupTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modFollowup_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
