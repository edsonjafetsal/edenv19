...
/**
 * \file    test/functional/linkcomercialFunctionalTest.php
...
/**
 * Class linkcomercialFunctionalTest
 *
 ...
 *
 * @package Testlinkcomercial
 */
class linkcomercialFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
...
//        )
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modlinkcomercial')->click();
		} else {
			// Disable the module
			$this->byHref('modlinkcomercial')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/linkcomercial/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('linkcomercial/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/linkcomercial/admin/about.php');
		$this->authenticate();
		return $this->assertContains('linkcomercial/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('linkcomercialwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modlinkcomercial_linkcomercialTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modlinkcomercial_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
