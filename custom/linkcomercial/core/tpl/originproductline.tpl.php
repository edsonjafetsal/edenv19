...
<!-- BEGIN PHP TEMPLATE originproductline.tpl.php mio -->
<?php
...
print '<td class="right"><input style="width: 60px;text-align: right;" type="number" size="2" name="torder[]" value="'.$this->tpl['qty'].'"></td>';
...
$selected = 1;
print '<td class="right">'.$line->stockreal.'</td>';
$form2 = new Form($db);

print '<td class="right">';
print '<input type="hidden" name="token" value="'.newToken().'">';
$presupuesto=new linkpresupuesto($db);
print $presupuesto::select_producto_fourn_price($this->tpl['fk_product'], 'fourn'.$this->tpl['fk_product'], GETPOST('socid'));
print '</td>';
