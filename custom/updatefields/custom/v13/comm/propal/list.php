...
//if (!GETPOST('confirmmassaction', 'alpha') && $massaction != 'presend' && $massaction != 'confirm_presend') { $massaction = ''; } ALAN
...
if ($resql)
{
	...
	while ($i < min($num, $limit))
	{
		...
		if (!empty($arrayfields['p.ref']['checked']))
		{
            ...
            $asd=$conf->global->CUSTOM_PDF_PROPALE;
            if($conf->global->CUSTOM_PDF_PROPALE){ //ALAN
