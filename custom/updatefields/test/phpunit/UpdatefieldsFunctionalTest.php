...
/**
 * \file    test/phpunit/UpdatefieldsFunctionalTest.php
...
/**
 * Class UpdatefieldsFunctionalTest
 *
 ...
 *
 * @package Testupdatefields
 */
class UpdatefieldsFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modUpdatefields')->click();
		} else {
			// Disable the module
			$this->byHref('modUpdatefields')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/updatefields/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('updatefields/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/updatefields/admin/about.php');
		$this->authenticate();
		return $this->assertContains('updatefields/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('updatefieldswidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modUpdatefields_UpdatefieldsTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modUpdatefields_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
