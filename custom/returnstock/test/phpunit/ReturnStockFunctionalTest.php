...
/**
 * \file    test/phpunit/ReturnStockFunctionalTest.php
 * \ingroup returnstock
...
/**
 * Class ReturnStockFunctionalTest
 *
 ...
 *
 * @package Testreturnstock
 */
class ReturnStockFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modReturnStock')->click();
		} else {
			// Disable the module
			$this->byHref('modReturnStock')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/returnstock/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('returnstock/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/returnstock/admin/about.php');
		$this->authenticate();
		return $this->assertContains('returnstock/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('returnstockwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modReturnStock_ReturnStockTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modReturnStock_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
