...
/**
 * \file    test/phpunit/DemoFunctionalTest.php
 * \ingroup demo
 ...
 * @package Testdemo
 */
class DemoFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/demo/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('demo/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/demo/admin/about.php');
		$this->authenticate();
		return $this->assertContains('demo/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('demowidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modDemo_DemoTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modDemo_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
