...
/**
 *  \file       core/modules/mechanic/doc/pdf_standard.modules.php
 *  \ingroup    mechanic
...
/**
 *	Class to manage PDF template standard_community
 */
class pdf_standard_community extends ModelePDFCommunity
{
	/**
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		/*
	    if (!empty($conf->global->MAIN_GENERATE_COMMUNITY_WITH_PICTURE))
	    {
		...
		*/
		...
		if ($conf->mechanic->dir_output.'/community')
		{
			...
			if ($object->specimen)
			{
				$dir = $conf->mechanic->dir_output.'/community';
				$file = $dir."/SPECIMEN.pdf";
			} else {
				$objectref = dol_sanitizeFileName($object->ref);
				$dir = $conf->mechanic->dir_output.'/community/'.$objectref;
