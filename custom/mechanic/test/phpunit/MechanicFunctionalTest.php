...
/**
 * \file    test/phpunit/MechanicFunctionalTest.php
 * \ingroup mechanic
 ...
 *
 * @package Testmechanic
 */
class MechanicFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/mechanic/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('mechanic/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/mechanic/admin/about.php');
		$this->authenticate();
		return $this->assertContains('mechanic/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('mechanicwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modMechanic_MechanicTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modMechanic_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
