    ...
    <div class="modal-dialog">
	    <div class="modal-content">
	    	<div class="modal-header">
		        ...
		        <h4 class="modal-title">Confirm the time spent</h4>
		    </div>
		    <div class="modal-body">
		        	...
		        	<div class="form-group">
		              <?php if ($user->rights->tasklist->all->write){ ?>
		              	 ...
		              	 <div class="input-group">
				              ...
				              <span class="input-group-addon" style="width:50%;" id="heure-addon1">Hour(s)</span>
			             </div>
			             <div class="input-group">
		       ...
		       <div class="modal-footer">
		       	<a class="btn btn-default" id="valide_popup">Validater</a>
		       	</div>  
	    </div>
    </div>
</div>
