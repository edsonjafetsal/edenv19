...
class ReqKbMainOrders extends CommonObject {
  ...
  public function getCodeSQL($_ORDERBY = '', $_isNewOrderBy = true, $_WHERE = '', $_isNewWhere = true, $_HAVING = '', $_isNewHaving = true) {
    ...
    $GROUPBY = "t.rowid,    id,  t.ref,    t.entity,    t.ref_ext,    t.ref_client,    t.fk_soc, "
  ...
  public function toArray() {
    $object_array = array();
    $fields_array = array('rowid', 'id', 'ref', 'entity', 'ref_ext', 'ref_client', 'fk_soc', 'fk_projet', 'tms', 'date_creation', 'date_valid', 'date_cloture', 'date_commande', 'fk_user_author', 'fk_user_modif', 'fk_user_valid', 'fk_user_cloture', 'source', 'fk_statut', 'amount_ht', 'remise_percent', 'remise_absolue', 'remise', 'tva', 'localtax1', 'localtax2', 'total_ht', 'total_ttc', 'note_private', 'note_public', 'facture', 'fk_currency', 'fk_cond_reglement', 'fk_mode_reglement', 'date_livraison', 'fk_warehouse', 'fk_availability', 'fk_input_reason', 'extraparams', 'societe_nom', 'societe_name_alias', 'societe_logo', 'nbre_lignes', 'nbre_produits', 'nbre_services',);
