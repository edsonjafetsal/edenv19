...
/**
 * \file    test/phpunit/VistaTestFunctionalTest.php
 * \ingroup vistatest
 ...
 *
 * @package Testvistatest
 */
class VistaTestFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modVistaTest')->click();
		} else {
			// Disable the module
			$this->byHref('modVistaTest')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/vistatest/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('vistatest/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/vistatest/admin/about.php');
		$this->authenticate();
		return $this->assertContains('vistatest/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('vistatestwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modVistaTest_VistaTestTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modVistaTest_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
