...
/**
 *	Class to manage PDF template standard_typedevelopment
 */
class pdf_standard_typedevelopment extends ModelePDFTypedevelopment
{
	/**
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		/*
	    if (!empty($conf->global->MAIN_GENERATE_TYPEDEVELOPMENT_WITH_PICTURE))
	    {
		...
		*/
		...
		if ($conf->devlog->dir_output.'/typedevelopment')
		{
			...
			if ($object->specimen)
			{
				$dir = $conf->devlog->dir_output.'/typedevelopment';
				$file = $dir."/SPECIMEN.pdf";
			} else {
				$objectref = dol_sanitizeFileName($object->ref);
				$dir = $conf->devlog->dir_output.'/typedevelopment/'.$objectref;
