...
/**
 *	Class to manage PDF template standard_task
 */
class pdf_standard_task extends ModelePDFTASK
{
	/**
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		/*
	    if (!empty($conf->global->MAIN_GENERATE_TASK_WITH_PICTURE))
	    {
		...
		*/
		...
		if ($conf->devlog->dir_output.'/task')
		{
			...
			if ($object->specimen)
			{
				$dir = $conf->devlog->dir_output.'/task';
				$file = $dir."/SPECIMEN.pdf";
			} else {
				$objectref = dol_sanitizeFileName($object->ref);
				$dir = $conf->devlog->dir_output.'/task/'.$objectref;
