...
/**
 *	Class to manage PDF template standard_projects
 */
class pdf_standard_projects extends ModelePDFPROJECTS
{
	/**
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		/*
	    if (!empty($conf->global->MAIN_GENERATE_PROJECTS_WITH_PICTURE))
	    {
		...
		*/
		...
		if ($conf->devlog->dir_output.'/projects')
		{
			...
			if ($object->specimen)
			{
				$dir = $conf->devlog->dir_output.'/projects';
				$file = $dir."/SPECIMEN.pdf";
			} else {
				$objectref = dol_sanitizeFileName($object->ref);
				$dir = $conf->devlog->dir_output.'/projects/'.$objectref;
