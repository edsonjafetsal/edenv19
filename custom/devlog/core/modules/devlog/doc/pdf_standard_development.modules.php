...
/**
 *	Class to manage PDF template standard_development
 */
class pdf_standard_development extends ModelePDFDevelopment
{
	/**
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		/*
	    if (!empty($conf->global->MAIN_GENERATE_DEVELOPMENT_WITH_PICTURE))
	    {
		...
		*/
		...
		if ($conf->devlog->dir_output.'/development')
		{
			...
			if ($object->specimen)
			{
				$dir = $conf->devlog->dir_output.'/development';
				$file = $dir."/SPECIMEN.pdf";
			} else {
				$objectref = dol_sanitizeFileName($object->ref);
				$dir = $conf->devlog->dir_output.'/development/'.$objectref;
