...
/**
 *  \file       core/modules/devlog/doc/pdf_standard.modules.php
 *  \ingroup    devlog
...
/**
 *	Class to manage PDF template standard_logsdevelopments
 */
class pdf_standard_logsdevelopments extends ModelePDFLogsdevelopments
{
	/**
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		/*
	    if (!empty($conf->global->MAIN_GENERATE_LOGSDEVELOPMENTS_WITH_PICTURE))
	    {
		...
		*/
		...
		if ($conf->devlog->dir_output.'/logsdevelopments')
		{
			...
			if ($object->specimen)
			{
				$dir = $conf->devlog->dir_output.'/logsdevelopments';
				$file = $dir."/SPECIMEN.pdf";
			} else {
				$objectref = dol_sanitizeFileName($object->ref);
				$dir = $conf->devlog->dir_output.'/logsdevelopments/'.$objectref;
