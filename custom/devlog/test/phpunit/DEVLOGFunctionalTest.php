...
/**
 * \file    test/phpunit/DEVLOGFunctionalTest.php
 * \ingroup devlog
 ...
 * @package Testdevlog
 */
class DEVLOGFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/devlog/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('devlog/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/devlog/admin/about.php');
		$this->authenticate();
		return $this->assertContains('devlog/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('devlogwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modDEVLOG_DEVLOGTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modDEVLOG_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
