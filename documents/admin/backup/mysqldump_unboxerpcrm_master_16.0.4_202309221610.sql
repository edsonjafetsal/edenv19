...
CREATE TABLE `llxas_bom_bomline_extrafields` (
  ...
  `fk_object` int(11) NOT NULL,
  `import_key` varchar(14) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `umtipo` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
  `umfl` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
  `fk_product` int(11) DEFAULT NULL,
  PRIMARY KEY (`rowid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `llxas_product_extrafields` (
  ...
  `fk_object` int(11) NOT NULL,
  `import_key` varchar(14) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `um` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `uma` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`rowid`),
...
) ENGINE=InnoDB AUTO_INCREMENT=4417 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-09-22 17:10:10
