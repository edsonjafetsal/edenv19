...
INSERT INTO `llxas_actioncomm` (`id`, `ref`, `ref_ext`, `entity`, `datep`, `datep2`, `fk_action`, `code`, `datec`, `tms`, `fk_user_author`, `fk_user_mod`, `fk_project`, `fk_soc`, `fk_contact`, `fk_parent`, `fk_user_action`, `fk_user_done`, `transparency`, `priority`, `visibility`, `fulldayevent`, `percent`, `location`, `durationp`, `label`, `note`, `calling_duration`, `email_subject`, `email_msgid`, `email_from`, `email_sender`, `email_to`, `email_tocc`, `email_tobcc`, `errors_to`, `reply_to`, `num_vote`, `event_paid`, `status`, `recurid`, `recurrule`, `recurdateend`, `fk_element`, `elementtype`, `import_key`, `extraparams`, `ip`) VALUES (1,'1',NULL,1,'2023-12-05 10:52:04','2023-12-05 10:52:04',40,'AC_PRODUCT_CREATE','2023-12-05 10:52:04','2023-12-05 15:52:04',1,NULL,NULL,NULL,NULL,0,1,NULL,0,0,'default',0,-1,'',NULL,'Product test_02 created','Product test_02 created',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,0,NULL,NULL,NULL,1,'product',NULL,NULL,NULL),(2,'2',NULL,1,'2024-01-23 19:13:44','2024-01-23 19:13:44',40,'AC_PRODUCT_DELETE','2024-01-23 19:13:44','2024-01-24 00:13:44',1,NULL,NULL,NULL,NULL,0,1,NULL,0,0,'default',0,-1,'',NULL,'Product test_02 deleted','Product test_02 deleted',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,0,NULL,NULL,NULL,1,'product',NULL,NULL,NULL);
...
INSERT INTO `llxas_actioncomm_resources` (`rowid`, `fk_actioncomm`, `element_type`, `fk_element`, `answer_status`, `mandatory`, `transparency`) VALUES (1,1,'user',1,'0',0,0),(2,2,'user',1,'0',0,0);
...
--
-- Table structure for table `llxas_bank_extrafields`
--

DROP TABLE IF EXISTS `llxas_bank_extrafields`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `llxas_bank_extrafields` (
  `rowid` int(11) NOT NULL AUTO_INCREMENT,
  `tms` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `fk_object` int(11) NOT NULL,
  `import_key` varchar(14) DEFAULT NULL,
...
--
-- Dumping data for table `llxas_bank_extrafields`
--

LOCK TABLES `llxas_bank_extrafields` WRITE;
/*!40000 ALTER TABLE `llxas_bank_extrafields` DISABLE KEYS */;
/*!40000 ALTER TABLE `llxas_bank_extrafields` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `llxas_bom_bom` (`rowid`, `entity`, `ref`, `bomtype`, `label`, `fk_product`, `description`, `note_public`, `note_private`, `fk_warehouse`, `qty`, `efficiency`, `duration`, `date_creation`, `date_valid`, `tms`, `fk_user_creat`, `fk_user_modif`, `fk_user_valid`, `import_key`, `model_pdf`, `status`) VALUES (1,1,'(PROV1)',0,'Design',1,NULL,NULL,NULL,NULL,1.00000000,1.00000000,3600.00000000,'2023-12-05 10:52:14',NULL,'2023-12-05 15:52:14',1,NULL,NULL,NULL,NULL,0);
...
CREATE TABLE `llxas_bom_bomline_extrafields` (
  ...
  `fk_object` int(11) NOT NULL,
  `import_key` varchar(14) DEFAULT NULL,
  `umtipo` varchar(20) NOT NULL,
  `umfl` varchar(20) NOT NULL,
  `fk_product` int(11) DEFAULT NULL,
  PRIMARY KEY (`rowid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `llxas_c_effectif` (`id`, `code`, `libelle`, `active`, `module`) VALUES (0,'EF0','-',1,NULL),(1,'EF1-5','1 - 5',1,NULL),(2,'EF6-10','6 - 10',1,NULL),(3,'EF11-50','11 - 50',1,NULL),(4,'EF51-100','51 - 100',1,NULL),(5,'EF101-500','101 - 500',1,NULL),(6,'EF500-','> 500',1,NULL);
...
INSERT INTO `llxas_c_hrm_public_holiday` (`id`, `entity`, `fk_country`, `code`, `dayrule`, `day`, `month`, `year`, `active`, `import_key`) VALUES (1,0,NULL,'NEWYEAR',NULL,1,1,0,1,NULL),(3,0,0,'ASSOMPTIONDAY1','',15,8,0,0,NULL),(20,0,0,'CHRISTMASDAY1','',25,12,0,1,''),(48,0,2,'BE-VICTORYDAY','',8,5,0,1,NULL),(49,0,2,'BE-NATIONALDAY','',21,7,0,1,NULL),(50,0,2,'BE-ASSOMPTION','',15,8,0,1,NULL),(51,0,2,'BE-TOUSSAINT','',1,11,0,1,NULL),(52,0,2,'BE-ARMISTICE','',11,11,0,1,NULL),(53,0,2,'BE-EASTER','eastermonday',0,0,0,1,NULL),(54,0,2,'BE-ASCENSION','ascension',0,0,0,1,NULL),(55,0,2,'BE-PENTECOST','pentecost',0,0,0,1,NULL);
...
INSERT INTO `llxas_c_tva` (`rowid`, `fk_pays`, `code`, `taux`, `localtax1`, `localtax1_type`, `localtax2`, `localtax2_type`, `recuperableonly`, `note`, `active`, `accountancy_code_sell`, `accountancy_code_buy`, `use_default`) VALUES (11,1,'',0,'0','0','0','0',0,'VAT Rate 0 ou non applicable',1,NULL,NULL,0),(12,1,'',20,'0','0','0','0',0,'VAT standard rate (France hors DOM-TOM)',1,NULL,NULL,0),(13,1,'',10,'0','0','0','0',0,'VAT reduced rate',1,NULL,NULL,0),(14,1,'',5.5,'0','0','0','0',0,'VAT reduced rate (France hors DOM-TOM)',1,NULL,NULL,0),(15,1,'',2.1,'0','0','0','0',0,'VAT super-reduced rate',1,NULL,NULL,0),(16,1,'85',8.5,'0','0','0','0',0,'VAT standard rate (DOM sauf Guyane et Saint-Martin)',0,NULL,NULL,0),(17,1,'85NPR',8.5,'0','0','0','0',1,'VAT standard rate (DOM sauf Guyane et Saint-Martin), non perçu par le vendeur mais récupérable par acheteur',0,NULL,NULL,0),(18,1,'85NPROM',8.5,'2','3','0','0',1,'VAT standard rate (DOM sauf Guyane et Saint-Martin), NPR, Octroi de Mer',0,NULL,NULL,0),(19,1,'85NPROMOMR',8.5,'2','3','2.5','3',1,'VAT standard rate (DOM sauf Guyane et Saint-Martin), NPR, Octroi de Mer et Octroi de Mer Regional',0,NULL,NULL,0),(21,2,'',0,'0','0','0','0',0,'VAT Rate 0 ou non applicable',1,NULL,NULL,0),(22,2,'',6,'0','0','0','0',0,'VAT reduced rate',1,NULL,NULL,0),(23,2,'',21,'0','0','0','0',0,'VAT standard rate',1,NULL,NULL,0),(24,2,'',12,'0','0','0','0',0,'VAT reduced rate',1,NULL,NULL,0),(31,3,'',0,'0','0','0','0',0,'VAT Rate 0',1,NULL,NULL,0),(32,3,'',10,'0','0','0','0',0,'VAT reduced rate',1,NULL,NULL,0),(33,3,'',4,'0','0','0','0',0,'VAT super-reduced rate',1,NULL,NULL,0),(34,3,'',22,'0','0','0','0',0,'VAT standard rate',1,NULL,NULL,0),(41,4,'',0,'0','3','-19:-15:-9','5',0,'VAT Rate 0',1,NULL,NULL,0),(42,4,'',10,'1.4','3','-19:-15:-9','5',0,'VAT reduced rate',1,NULL,NULL,0),(43,4,'',4,'0.5','3','-19:-15:-9','5',0,'VAT super-reduced rate',1,NULL,NULL,0),(44,4,'',21,'5.2','3','-19:-15:-9','5',0,'VAT standard rate',1,NULL,NULL,0),(51,5,'',0,'0','0','0','0',0,'No VAT',1,NULL,NULL,0),(52,5,'',7,'0','0','0','0',0,'ermäßigte USt.',1,NULL,NULL,0),(54,5,'',5.5,'0','0','0','0',0,'USt. Forst',0,NULL,NULL,0),(55,5,'',10.7,'0','0','0','0',0,'USt. Landwirtschaft',0,NULL,NULL,0),(56,5,'',19,'0','0','0','0',0,'allgemeine Ust.',1,NULL,NULL,0),(61,6,'',0,'0','0','0','0',0,'VAT Rate 0',1,NULL,NULL,0),(62,6,'',3.7,'0','0','0','0',0,'VAT reduced rate',1,NULL,NULL,0),(63,6,'',2.5,'0','0','0','0',0,'VAT super-reduced rate',1,NULL,NULL,0),(64,6,'',7.7,'0','0','0','0',0,'VAT standard rate',1,NULL,NULL,0),(71,7,'',0,'0','0','0','0',0,'VAT Rate 0',1,NULL,NULL,0),(72,7,'',17.5,'0','0','0','0',0,'VAT standard rate before 2011',1,NULL,NULL,0),(73,7,'',5,'0','0','0','0',0,'VAT reduced rate',1,NULL,NULL,0),(74,7,'',20,'0','0','0','0',0,'VAT standard rate',1,NULL,NULL,0),(81,8,'',0,'0','0','0','0',0,'VAT Rate 0',1,NULL,NULL,0),(82,8,'',23,'0','0','0','0',0,'VAT standard rate',1,NULL,NULL,0),(83,8,'',13.5,'0','0','0','0',0,'VAT reduced rate',1,NULL,NULL,0),(84,8,'',9,'0','0','0','0',0,'VAT reduced rate',1,NULL,NULL,0),(85,8,'',4.8,'0','0','0','0',0,'VAT reduced rate',1,NULL,NULL,0),(91,9,'',0,'0','0','0','0',0,'VAT Rate 0',1,NULL,NULL,0),(92,9,'',13,'0','0','0','0',0,'VAT reduced rate 0',1,NULL,NULL,0),(93,9,'',3,'0','0','0','0',0,'VAT super reduced rate 0',1,NULL,NULL,0),(94,9,'',17,'0','0','0','0',0,'VAT standard rate',1,NULL,NULL,0),(101,10,'',0,'0','0','0','0',0,'VAT Rate 0',1,NULL,NULL,0),(102,10,'',12,'0','0','0','0',0,'VAT 12%',1,NULL,NULL,0),(103,10,'',18,'0','0','0','0',0,'VAT 18%',1,NULL,NULL,0),(104,10,'',7.5,'0','0','0','0',0,'VAT 6% Majoré à 25% (7.5%)',1,NULL,NULL,0),(105,10,'',15,'0','0','0','0',0,'VAT 12% Majoré à 25% (15%)',1,NULL,NULL,0),(106,10,'',22.5,'0','0','0','0',0,'VAT 18% Majoré à 25% (22.5%)',1,NULL,NULL,0),(107,10,'',6,'0','0','0','0',0,'VAT 6%',1,NULL,NULL,0),(111,11,'',0,'0','0','0','0',0,'No Sales Tax',1,NULL,NULL,0),(112,11,'',4,'0','0','0','0',0,'Sales Tax 4%',1,NULL,NULL,0),(113,11,'',6,'0','0','0','0',0,'Sales Tax 6%',1,NULL,NULL,0),(121,12,'',0,'0','0','0','0',0,'VAT Rate 0',1,NULL,NULL,0),(122,12,'',14,'0','0','0','0',0,'VAT reduced rate',1,NULL,NULL,0),(123,12,'',10,'0','0','0','0',0,'VAT reduced rate',1,NULL,NULL,0),(124,12,'',7,'0','0','0','0',0,'VAT super-reduced rate',1,NULL,NULL,0),(125,12,'',20,'0','0','0','0',0,'VAT standard rate',1,NULL,NULL,0),(131,13,'',0,'0','0','0','0',0,'TVA 0%',1,NULL,NULL,0),(132,13,'',9,'0','0','0','0',0,'TVA 9%',1,NULL,NULL,0),(133,13,'',19,'0','0','0','0',0,'TVA 19%',1,NULL,NULL,0),(141,14,'',0,'0','0','0','0',0,'VAT Rate 0',1,NULL,NULL,0),(142,14,'',7,'0','0','0','0',0,'VAT standard rate',1,NULL,NULL,0),(143,14,'',5,'9.975','1','0','0',0,'GST/TPS and PST/TVQ rate for Province',1,NULL,NULL,0),(171,17,'',0,'0','0','0','0',0,'0 BTW tarief',1,NULL,NULL,0),(172,17,'',6,'0','0','0','0',0,'Verlaagd BTW tarief',1,NULL,NULL,0),(173,17,'',19,'0','0','0','0',0,'Algemeen BTW tarief',1,NULL,NULL,0),(174,17,'',21,'0','0','0','0',0,'Algemeen BTW tarief (vanaf 1 oktober 2012)',0,NULL,NULL,0),(201,20,'',0,'0','0','0','0',0,'VAT Rate 0',1,NULL,NULL,0),(202,20,'',12,'0','0','0','0',0,'VAT reduced rate',1,NULL,NULL,0),(203,20,'',6,'0','0','0','0',0,'VAT super-reduced rate',1,NULL,NULL,0),(204,20,'',25,'0','0','0','0',0,'VAT standard rate',1,NULL,NULL,0),(211,21,'',0,'0','0','0','0',0,'IVA Rate 0',1,NULL,NULL,0),(212,21,'',18,'7.5','2','0','0',0,'IVA standard rate',1,NULL,NULL,0),(221,22,'',0,'0','0','0','0',0,'VAT Rate 0',1,NULL,NULL,0),(222,22,'',10,'0','0','0','0',0,'VAT reduced rate',1,NULL,NULL,0),(223,22,'',18,'0','0','0','0',0,'VAT standard rate',1,NULL,NULL,0),(231,23,'',0,'0','0','0','0',0,'IVA Rate 0',1,NULL,NULL,0),(232,23,'',10.5,'0','0','0','0',0,'IVA reduced rate',1,NULL,NULL,0),(233,23,'',21,'0','0','0','0',0,'IVA standard rate',1,NULL,NULL,0),(241,24,'',0,'0','0','0','0',0,'VAT Rate 0',1,NULL,NULL,0),(242,24,'',19.25,'0','0','0','0',0,'VAT standard rate',1,NULL,NULL,0),(251,25,'',0,'0','0','0','0',0,'VAT Rate 0',1,NULL,NULL,0),(252,25,'',13,'0','0','0','0',0,'VAT reduced rate',1,NULL,NULL,0),(253,25,'',23,'0','0','0','0',0,'VAT standard rate',1,NULL,NULL,0),(254,25,'',6,'0','0','0','0',0,'VAT reduced rate',1,NULL,NULL,0),(261,26,'',0,'0','0','0','0',0,'VAT Rate 0',1,NULL,NULL,0),(262,26,'',5,'0','0','0','0',0,'VAT Rate 5',1,NULL,NULL,0),(271,27,'',0,'0','0','0','0',0,'VAT Rate 0 ou non applicable',1,NULL,NULL,0),(272,27,'',8.5,'0','0','0','0',0,'VAT standard rate (DOM sauf Guyane et Saint-Martin)',0,NULL,NULL,0),(273,27,'',8.5,'0','0','0','0',1,'VAT standard rate (DOM sauf Guyane et Saint-Martin), non perçu par le vendeur mais récupérable par acheteur',0,NULL,NULL,0),(274,27,'',5.5,'0','0','0','0',0,'VAT reduced rate (France hors DOM-TOM)',0,NULL,NULL,0),(275,27,'',19.6,'0','0','0','0',0,'VAT standard rate (France hors DOM-TOM)',1,NULL,NULL,0),(276,27,'',2.1,'0','0','0','0',0,'VAT super-reduced rate',1,NULL,NULL,0),(277,27,'',7,'0','0','0','0',0,'VAT reduced rate',1,NULL,NULL,0),(281,28,'',0,'0','0','0','0',0,'VAT Rate 0',1,NULL,NULL,0),(282,28,'',10,'0','0','0','0',0,'VAT standard rate',1,NULL,NULL,0),(351,35,'',0,'0','0','0','0',0,'VAT Rate 0',1,NULL,NULL,0),(352,35,'',7,'0','0','0','0',0,'VAT reduced rate',1,NULL,NULL,0),(353,35,'',14,'0','0','0','0',0,'VAT standard rate',1,NULL,NULL,0),(411,41,'',0,'0','0','0','0',0,'VAT Rate 0',1,NULL,NULL,0),(412,41,'',10,'0','0','0','0',0,'VAT reduced rate',1,NULL,NULL,0),(413,41,'',20,'0','0','0','0',0,'VAT standard rate',1,NULL,NULL,0),(461,46,'',0,'0','0','0','0',0,'No VAT',1,NULL,NULL,0),(462,46,'',15,'0','0','0','0',0,'VAT 15%',1,NULL,NULL,0),(463,46,'',7.5,'0','0','0','0',0,'VAT 7.5%',1,NULL,NULL,0),(561,56,'',0,'0','0','0','0',0,'VAT reduced rate',1,NULL,NULL,0),(591,59,'',0,'0','0','0','0',0,'VAT Rate 0',1,NULL,NULL,0),(592,59,'',7,'0','0','0','0',0,'VAT reduced rate',1,NULL,NULL,0),(593,59,'',20,'0','0','0','0',0,'VAT standard rate',1,NULL,NULL,0),(671,67,'',0,'0','0','0','0',0,'VAT Rate 0',1,NULL,NULL,0),(672,67,'',19,'0','0','0','0',0,'VAT standard rate',1,NULL,NULL,0),(721,72,'',0,'0','0','0','0',0,'VAT Rate 0',1,NULL,NULL,0),(722,72,'',18,'0.9','1','0','0',0,'VAT Rate 18+0.9',1,NULL,NULL,0),(781,78,'',0,'0','0','0','0',0,'VAT Rate 0',1,NULL,NULL,0),(782,78,'',9,'0','0','0','0',0,'VAT Rate 9',1,NULL,NULL,0),(783,78,'',5,'0','0','0','0',0,'VAT Rate 5',1,NULL,NULL,0),(784,78,'',19,'0','0','0','0',0,'VAT standard rate',1,NULL,NULL,0),(801,80,'',0,'0','0','0','0',0,'VAT Rate 0',1,NULL,NULL,0),(802,80,'',25,'0','0','0','0',0,'VAT standard rate',1,NULL,NULL,0),(861,86,'',0,'0','0','0','0',0,'SIN IVA',1,NULL,NULL,0),(862,86,'',13,'0','0','0','0',0,'IVA 13',1,NULL,NULL,0),(1021,102,'',0,'0','0','0','0',0,'Μηδενικό Φ.Π.Α.',1,NULL,NULL,0),(1022,102,'',24,'0','0','0','0',0,'Κανονικός Φ.Π.Α.',1,NULL,NULL,0),(1023,102,'',13,'0','0','0','0',0,'Μειωμένος Φ.Π.Α.',1,NULL,NULL,0),(1024,102,'',6,'0','0','0','0',0,'Υπερμειωμένος Φ.Π.Α.',1,NULL,NULL,0),(1025,102,'',16,'0','0','0','0',0,'Νήσων κανονικός Φ.Π.Α.',1,NULL,NULL,0),(1026,102,'',9,'0','0','0','0',0,'Νήσων μειωμένος Φ.Π.Α.',1,NULL,NULL,0),(1027,102,'',4,'0','0','0','0',0,'Νήσων υπερμειωμένος Φ.Π.Α.',1,NULL,NULL,0),(1028,102,'',17,'0','0','0','0',0,'Νήσων υπερμειωμένος Φ.Π.Α.',1,NULL,NULL,0),(1141,114,'',0,'0','0','0','0',0,'No ISV',1,NULL,NULL,0),(1142,114,'',12,'0','0','0','0',0,'ISV 12%',1,NULL,NULL,0),(1161,116,'',0,'0','0','0','0',0,'VAT rate 0',1,NULL,NULL,0),(1162,116,'',7,'0','0','0','0',0,'VAT reduced rate',1,NULL,NULL,0),(1163,116,'',25.5,'0','0','0','0',0,'VAT standard rate',1,NULL,NULL,0),(1171,117,'',0,'0','0','0','0',0,'VAT Rate 0',0,NULL,NULL,0),(1172,117,'C+S-5',0,'2.5','1','2.5','1',0,'CGST+SGST - Same state sales',1,NULL,NULL,0),(1173,117,'I-5',5,'0','0','0','0',0,'IGST',1,NULL,NULL,0),(1174,117,'C+S-12',0,'6','1','6','1',0,'CGST+SGST - Same state sales',1,NULL,NULL,0),(1175,117,'I-12',12,'0','0','0','0',0,'IGST',1,NULL,NULL,0),(1176,117,'C+S-18',0,'9','1','9','1',0,'CGST+SGST - Same state sales',1,NULL,NULL,0),(1177,117,'I-18',18,'0','0','0','0',0,'IGST',1,NULL,NULL,0),(1178,117,'C+S-28',0,'14','1','14','1',0,'CGST+SGST - Same state sales',1,NULL,NULL,0),(1179,117,'I-28',28,'0','0','0','0',0,'IGST',1,NULL,NULL,0),(1231,123,'',0,'0','0','0','0',0,'VAT Rate 0',1,NULL,NULL,0),(1232,123,'',5,'0','0','0','0',0,'VAT Rate 5',1,NULL,NULL,0),(1401,140,'',0,'0','0','0','0',0,'VAT Rate 0',1,NULL,NULL,0),(1402,140,'',14,'0','0','0','0',0,'VAT intermediary rate',1,NULL,NULL,0),(1403,140,'',8,'0','0','0','0',0,'VAT reduced rate',1,NULL,NULL,0),(1404,140,'',3,'0','0','0','0',0,'VAT super-reduced rate',1,NULL,NULL,0),(1405,140,'',17,'0','0','0','0',0,'VAT standard rate',1,NULL,NULL,0),(1481,148,'',0,'0','0','0','0',0,'VAT Rate 0',1,NULL,NULL,0),(1482,148,'',7,'0','0','0','0',0,'VAT reduced rate',1,NULL,NULL,0),(1483,148,'',5,'0','0','0','0',0,'VAT super-reduced rate',1,NULL,NULL,0),(1484,148,'',18,'0','0','0','0',0,'VAT standard rate',1,NULL,NULL,0),(1511,151,'',0,'0','0','0','0',0,'VAT Rate 0',1,NULL,NULL,0),(1512,151,'',14,'0','0','0','0',0,'VAT Rate 14',1,NULL,NULL,0),(1521,152,'',0,'0','0','0','0',0,'VAT Rate 0',1,NULL,NULL,0),(1522,152,'',15,'0','0','0','0',0,'VAT Rate 15',1,NULL,NULL,0),(1541,154,'',0,'0','0','0','0',0,'No VAT',1,NULL,NULL,0),(1542,154,'',16,'0','0','0','0',0,'VAT 16%',1,NULL,NULL,0),(1543,154,'',10,'0','0','0','0',0,'VAT Frontero',1,NULL,NULL,0),(1651,165,'',0,'0','0','0','0',0,'VAT Rate 0',1,NULL,NULL,0),(1652,165,'',3,'0','0','0','0',0,'VAT standard 3',1,NULL,NULL,0),(1653,165,'',6,'0','0','0','0',0,'VAT standard 6',1,NULL,NULL,0),(1654,165,'',11,'0','0','0','0',0,'VAT standard rate',1,NULL,NULL,0),(1655,165,'',22,'0','0','0','0',0,'VAT standard high',1,NULL,NULL,0),(1661,166,'',0,'0','0','0','0',0,'VAT Rate 0',1,NULL,NULL,0),(1662,166,'',15,'0','0','0','0',0,'VAT standard rate',1,NULL,NULL,0),(1691,169,'',0,'0','0','0','0',0,'VAT Rate 0',1,NULL,NULL,0),(1692,169,'',5,'0','0','0','0',0,'VAT standard rate',1,NULL,NULL,0),(1731,173,'',0,'0','0','0','0',0,'VAT Rate 0',1,NULL,NULL,0),(1732,173,'',14,'0','0','0','0',0,'VAT reduced rate',1,NULL,NULL,0),(1733,173,'',8,'0','0','0','0',0,'VAT reduced rate',1,NULL,NULL,0),(1734,173,'',25,'0','0','0','0',0,'VAT standard rate',1,NULL,NULL,0),(1781,178,'',0,'0','0','0','0',0,'ITBMS Rate 0',1,NULL,NULL,0),(1782,178,'',7,'0','0','0','0',0,'ITBMS standard rate',1,NULL,NULL,0),(1811,181,'',0,'0','0','0','0',0,'VAT Rate 0',1,NULL,NULL,0),(1818,181,'',18,'0','0','0','0',0,'VAT standard rate',1,NULL,NULL,0),(1841,184,'',0,'0','0','0','0',0,'VAT Rate 0',1,NULL,NULL,0),(1842,184,'',8,'0','0','0','0',0,'VAT reduced rate',1,NULL,NULL,0),(1843,184,'',3,'0','0','0','0',0,'VAT reduced rate',1,NULL,NULL,0),(1844,184,'',23,'0','0','0','0',0,'VAT standard rate',1,NULL,NULL,0),(1881,188,'',0,'0','0','0','0',0,'VAT Rate 0',1,NULL,NULL,0),(1882,188,'',9,'0','0','0','0',0,'VAT reduced rate',1,NULL,NULL,0),(1883,188,'',19,'0','0','0','0',0,'VAT standard rate',1,NULL,NULL,0),(1884,188,'',5,'0','0','0','0',0,'VAT reduced rate',1,NULL,NULL,0),(1931,193,'',0,'0','0','0','0',0,'No VAT in SPM',1,NULL,NULL,0),(2011,201,'',0,'0','0','0','0',0,'VAT Rate 0',1,NULL,NULL,0),(2012,201,'',10,'0','0','0','0',0,'VAT reduced rate',1,NULL,NULL,0),(2013,201,'',19,'0','0','0','0',0,'VAT standard rate',1,NULL,NULL,0),(2021,202,'',0,'0','0','0','0',0,'VAT Rate 0',1,NULL,NULL,0),(2022,202,'',9.5,'0','0','0','0',0,'VAT reduced rate',1,NULL,NULL,0),(2023,202,'',22,'0','0','0','0',0,'VAT standard rate',1,NULL,NULL,0),(2051,205,'',0,'0','0','0','0',0,'VAT Rate 0',1,NULL,NULL,0),(2052,205,'',15,'0','0','0','0',0,'VAT standard rate',1,NULL,NULL,0),(2071,207,'',0,'0','0','0','0',0,'VAT 0',1,NULL,NULL,0),(2072,207,'',15,'0','0','0','0',0,'VAT 15%',1,NULL,NULL,0),(2131,213,'',0,'0','0','0','0',0,'VAT 0',1,NULL,NULL,0),(2132,213,'',5,'0','0','0','0',0,'VAT 5%',1,NULL,NULL,0),(2261,226,'',0,'0','0','0','0',0,'VAT Rate 0',1,NULL,NULL,0),(2262,226,'',20,'0','0','0','0',0,'VAT standart rate',1,NULL,NULL,0),(2321,232,'',0,'0','0','0','0',0,'No VAT',1,NULL,NULL,0),(2322,232,'',12,'0','0','0','0',0,'VAT 12%',1,NULL,NULL,0),(2323,232,'',8,'0','0','0','0',0,'VAT 8%',1,NULL,NULL,0),(2461,246,'',0,'0','0','0','0',0,'VAT Rate 0',1,NULL,NULL,0);
...
INSERT INTO `llxas_cronjob` (`rowid`, `tms`, `datec`, `jobtype`, `label`, `command`, `classesname`, `objectname`, `methodename`, `params`, `md5params`, `module_name`, `priority`, `datelastrun`, `datenextrun`, `datestart`, `dateend`, `datelastresult`, `lastresult`, `lastoutput`, `unitfrequency`, `frequency`, `maxrun`, `nbrun`, `autodelete`, `status`, `processing`, `test`, `fk_user_author`, `fk_user_mod`, `fk_mailing`, `note`, `libname`, `entity`, `email_alert`, `pid`) VALUES (1,'2022-02-11 22:55:42','2022-02-11 17:55:42','method','SendEmailsReminders',NULL,'comm/action/class/actioncomm.class.php','ActionComm','sendEmailsReminder',NULL,NULL,'agenda',10,NULL,NULL,'2022-02-11 17:55:42',NULL,NULL,NULL,NULL,'60',5,0,NULL,0,1,0,'$conf->agenda->enabled',NULL,NULL,NULL,'SendEMailsReminder',NULL,1,NULL,NULL),(2,'2023-09-08 21:40:13','2022-05-23 17:43:06','method','RecurringInvoicesJob',NULL,'compta/facture/class/facture-rec.class.php','FactureRec','createRecurringInvoices',NULL,NULL,'facture',50,NULL,NULL,'2022-05-23 23:00:00',NULL,NULL,NULL,NULL,'86400',1,0,NULL,0,1,0,'$conf->facture->enabled',NULL,NULL,NULL,'Generate recurring invoices',NULL,1,NULL,NULL),(3,'2023-04-12 23:52:59','2023-04-12 19:52:59','method','SendEmailsRemindersOnInvoiceDueDate',NULL,'compta/facture/class/facture.class.php','Facture','sendEmailsRemindersOnInvoiceDueDate','10,all,EmailTemplateCode',NULL,'facture',50,NULL,NULL,'2023-04-12 23:00:00',NULL,NULL,NULL,NULL,'86400',1,0,NULL,0,0,0,'$conf->facture->enabled',NULL,NULL,NULL,'Send an emails when the unpaid invoices reach a due date + n days = today. First param is the offset n of days, second parameter is \"all\" or a payment mode code, last parameter is the code of email template to use (an email template with EmailTemplateCode must exists. the version in the language of the thirdparty will be used in priority).',NULL,1,NULL,NULL),(4,'2023-04-12 23:53:00','2023-04-12 19:53:00','method','HolidayBalanceMonthlyUpdate',NULL,'holiday/class/holiday.class.php','Holiday','updateBalance',NULL,NULL,'holiday',50,NULL,NULL,'2023-04-12 04:00:00',NULL,NULL,NULL,NULL,'86400',1,0,NULL,0,1,0,'$conf->holiday->enabled',NULL,NULL,NULL,'Update holiday balance every month',NULL,1,NULL,NULL),(5,'2023-09-08 21:40:41','2023-09-08 17:40:41','method','RecurringSupplierInvoicesJob',NULL,'fourn/class/fournisseur.facture-rec.class.php','FactureFournisseurRec','createRecurringInvoices',NULL,NULL,'fournisseur',51,NULL,NULL,'2023-09-08 23:00:00',NULL,NULL,NULL,NULL,'86400',1,0,NULL,0,1,0,'',NULL,NULL,NULL,'Generate recurring supplier invoices',NULL,1,NULL,NULL),(6,'2023-12-04 18:56:38','2023-12-04 13:56:38','method','HolidayBalanceMonthlyUpdate:holiday',NULL,'holiday/class/holiday.class.php','Holiday','updateBalance',NULL,NULL,'holiday',50,NULL,NULL,'2023-12-04 04:00:00',NULL,NULL,NULL,NULL,'86400',1,0,NULL,0,1,0,'$conf->holiday->enabled',NULL,NULL,NULL,'Update holiday balance every month',NULL,1,NULL,NULL);
...
--
-- Table structure for table `llxas_element_categorie`
--

DROP TABLE IF EXISTS `llxas_element_categorie`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `llxas_element_categorie` (
  `rowid` int(11) NOT NULL AUTO_INCREMENT,
  `fk_categorie` int(11) NOT NULL,
  `fk_element` int(11) NOT NULL,
  `import_key` varchar(14) DEFAULT NULL,
  ...
  CONSTRAINT `fk_element_categorie_fk_categorie` FOREIGN KEY (`fk_categorie`) REFERENCES `llxas_categorie` (`rowid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `llxas_element_categorie`
--

LOCK TABLES `llxas_element_categorie` WRITE;
/*!40000 ALTER TABLE `llxas_element_categorie` DISABLE KEYS */;
/*!40000 ALTER TABLE `llxas_element_categorie` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `llxas_extrafields` (`rowid`, `name`, `entity`, `elementtype`, `label`, `type`, `size`, `fieldcomputed`, `fielddefault`, `fieldunique`, `fieldrequired`, `perms`, `enabled`, `pos`, `alwayseditable`, `param`, `list`, `printable`, `totalizable`, `langs`, `help`, `fk_user_author`, `fk_user_modif`, `datec`, `tms`, `css`, `cssview`, `csslist`) VALUES (1,'product',1,'ticket','Product','sellist','',NULL,NULL,0,0,NULL,'1',1,1,'a:1:{s:7:\"options\";a:1:{s:41:\"product:label:rowid:: fk_product_type = 0\";N;}}','1',0,1,NULL,NULL,1,1,'2022-02-11 17:57:14','2022-02-11 22:57:14',NULL,NULL,NULL),(2,'umfl',1,'facturedet','UMLINEA','varchar','20',NULL,NULL,1,1,NULL,'1',100,0,'a:1:{s:7:\"options\";a:1:{s:0:\"\";N;}}','0',0,0,'unidadmedida@unidadmedida',NULL,1,1,'2018-11-04 20:04:06','2023-09-19 14:26:11',NULL,NULL,NULL),(3,'umtipo',1,'facturedet','umtipo','varchar','20',NULL,NULL,1,1,NULL,'1',100,0,'a:1:{s:7:\"options\";a:1:{s:0:\"\";N;}}','0',0,0,'unidadmedida@unidadmedida',NULL,1,1,'2018-11-04 22:23:21','2023-09-19 14:26:11',NULL,NULL,NULL),(4,'umfl',1,'mrp_mo','UMLINEA','varchar','20',NULL,NULL,1,1,NULL,'1',100,0,'a:1:{s:7:\"options\";a:1:{s:0:\"\";N;}}','0',0,0,'unidadmedida@unidadmedida',NULL,1,1,'2021-11-18 22:11:10','2023-09-19 14:26:11',NULL,NULL,NULL),(5,'umtipo',1,'mrp_mo','umtipo','varchar','20',NULL,NULL,1,1,NULL,'1',100,0,'a:1:{s:7:\"options\";a:1:{s:0:\"\";N;}}','0',0,0,'unidadmedida@unidadmedida',NULL,1,1,'2021-11-18 22:13:42','2023-09-19 14:26:11',NULL,NULL,NULL),(6,'umfl',0,'bom_bomline','UMLINEA','varchar','20','',NULL,0,0,NULL,'1',12,1,'a:1:{s:7:\"options\";a:1:{s:0:\"\";N;}}','0',0,0,NULL,'',1,1,'2021-12-29 00:00:00','2021-12-30 04:01:24',NULL,NULL,NULL),(7,'umtipo',0,'bom_bomline','umtipo','varchar','20','',NULL,0,0,NULL,'1',12,1,'a:1:{s:7:\"options\";a:1:{s:0:\"\";N;}}','0',0,0,NULL,'',1,1,'2021-12-29 00:00:00','2021-12-30 08:16:23',NULL,NULL,NULL),(8,'fk_product',0,'bom_bomline','fk_product','int','10','',NULL,0,0,NULL,'1',12,1,'a:1:{s:7:\"options\";a:1:{s:0:\"\";N;}}','0',0,0,NULL,'',1,1,'2021-12-29 00:00:00','2021-12-30 08:16:17',NULL,NULL,NULL),(9,'um',1,'product','UnidadmedidaFacturacion','sellist','',NULL,NULL,0,0,NULL,'$conf->unidadmedida->enabled',1,0,'a:1:{s:7:\"options\";a:1:{s:29:\"c_units:label:rowid::active=1\";N;}}','1',0,0,'unidadmedida@unidadmedida',NULL,1,1,'2023-09-19 10:26:11','2023-09-19 14:26:11',NULL,NULL,NULL),(10,'uma',1,'product','UnidadmedidaAltFacturacion','sellist','',NULL,NULL,0,0,NULL,'$conf->unidadmedida->enabled',1,0,'a:1:{s:7:\"options\";a:1:{s:29:\"c_units:label:rowid::active=1\";N;}}','1',0,0,'unidadmedida@unidadmedida',NULL,1,1,'2023-09-19 10:26:11','2023-09-19 14:26:11',NULL,NULL,NULL);
...
INSERT INTO `llxas_menu` (`rowid`, `menu_handler`, `entity`, `module`, `type`, `mainmenu`, `leftmenu`, `fk_menu`, `fk_mainmenu`, `fk_leftmenu`, `position`, `url`, `target`, `titre`, `prefix`, `langs`, `level`, `perms`, `enabled`, `usertype`, `tms`) VALUES (1,'all',1,'reports','top','reports','1',0,NULL,NULL,100,'/reports/index.php','','Reports',NULL,'reports@reports',NULL,'$user->rights->reports->use','$conf->reports->enabled',0,'2021-11-22 16:06:01'),(27,'all',1,'kanview','top','kanview',NULL,0,NULL,NULL,100,'/kanview/view/kanview_board.php','','Kanview_TopMenu_Dashboard',NULL,'kanview@kanview',NULL,'$user->rights->kanview->canuse','$conf->kanview->enabled',0,'2022-08-17 22:42:31'),(28,'all',1,'kanview','left','kanview',NULL,27,NULL,NULL,200,'/kanview/view/projets_kb.php','','Kanview_LeftMenu_Projet_Kanban',NULL,'kanview@kanview',NULL,'((!$conf->global->MAIN_USE_ADVANCED_PERMS) && $conf->kanview->enabled && $user->rights->kanview->canuse && $conf->projet->enabled && $user->rights->projet->lire) || ($conf->global->MAIN_USE_ADVANCED_PERMS && $conf->kanview->enabled && $user->rights->kanview->canuse && $conf->projet->enabled && $user->rights->projet->lire && $user->rights->kanview->kanview_advance->canuse_projects)','$conf->kanview->enabled && $conf->projet->enabled',0,'2022-08-17 22:42:31'),(29,'all',1,'kanview','left','kanview',NULL,27,NULL,NULL,250,'/kanview/view/tasks_kb.php','','Kanview_LeftMenu_ProjetTask_Kanban',NULL,'kanview@kanview',NULL,'((!$conf->global->MAIN_USE_ADVANCED_PERMS) && $conf->kanview->enabled && $user->rights->kanview->canuse && $conf->projet->enabled && $user->rights->projet->lire) || ($conf->global->MAIN_USE_ADVANCED_PERMS && $conf->kanview->enabled && $user->rights->kanview->canuse && $conf->projet->enabled && $user->rights->projet->lire && $user->rights->kanview->kanview_advance->canuse_tasks)','$conf->kanview->enabled && $conf->projet->enabled',0,'2022-08-17 22:42:31'),(30,'all',1,'kanview','left','kanview',NULL,27,NULL,NULL,300,'/kanview/view/propals_kb.php','','Kanview_LeftMenu_Propal_Kanban',NULL,'kanview@kanview',NULL,'((!$conf->global->MAIN_USE_ADVANCED_PERMS) && $conf->kanview->enabled && $user->rights->kanview->canuse && $conf->propal->enabled && $user->rights->propale->lire && $user->rights->propale->creer && $user->rights->propale->cloturer) || ($conf->global->MAIN_USE_ADVANCED_PERMS && $conf->kanview->enabled && $user->rights->kanview->canuse && $conf->propal->enabled && $user->rights->propale->lire && $user->rights->propale->creer && $user->rights->propale->cloturer && $user->rights->kanview->kanview_advance->canuse_propals && $user->rights->propale->propal_advance->validate && 1)','$conf->kanview->enabled && $conf->propal->enabled',0,'2022-08-17 22:42:31'),(31,'all',1,'kanview','left','kanview',NULL,27,NULL,NULL,400,'/kanview/view/orders_kb.php','','Kanview_LeftMenu_Commande_Kanban',NULL,'kanview@kanview',NULL,'((!$conf->global->MAIN_USE_ADVANCED_PERMS) && $conf->kanview->enabled && $user->rights->kanview->canuse && $conf->commande->enabled && $user->rights->commande->lire && $user->rights->commande->creer) || ($conf->global->MAIN_USE_ADVANCED_PERMS && $conf->kanview->enabled && $user->rights->kanview->canuse && $conf->commande->enabled && $user->rights->commande->lire && $user->rights->commande->creer && $user->rights->kanview->kanview_advance->canuse_orders && $user->rights->commande->order_advance->validate && $user->rights->commande->order_advance->annuler && $user->rights->commande->order_advance->close)','$conf->kanview->enabled && $conf->commande->enabled',0,'2022-08-17 22:42:31'),(32,'all',1,'kanview','left','kanview',NULL,27,NULL,NULL,500,'/kanview/view/invoices_kb.php','','Kanview_LeftMenu_Facture_Kanban',NULL,'kanview@kanview',NULL,'((!$conf->global->MAIN_USE_ADVANCED_PERMS) && $conf->kanview->enabled && $user->rights->kanview->canuse && $conf->facture->enabled && $user->rights->facture->lire && $user->rights->facture->creer && $user->rights->facture->paiement) || ($conf->global->MAIN_USE_ADVANCED_PERMS && $conf->kanview->enabled && $user->rights->kanview->canuse && $conf->facture->enabled && $user->rights->facture->lire && $user->rights->facture->creer && $user->rights->facture->paiement && $user->rights->kanview->kanview_advance->canuse_invoices && $user->rights->facture->invoice_advance->unvalidate && $user->rights->facture->invoice_advance->validate)','$conf->kanview->enabled && $conf->facture->enabled',0,'2022-08-17 22:42:31'),(33,'all',1,'kanview','left','kanview',NULL,27,NULL,NULL,600,'/kanview/view/prospects_kb.php','','Kanview_LeftMenu_Societe_Kanban',NULL,'kanview@kanview',NULL,'((!$conf->global->MAIN_USE_ADVANCED_PERMS) && $conf->kanview->enabled && $user->rights->kanview->canuse && $conf->societe->enabled && $user->rights->societe->lire && $user->rights->societe->creer) || ($conf->global->MAIN_USE_ADVANCED_PERMS && $conf->kanview->enabled && $user->rights->kanview->canuse && $conf->societe->enabled && $user->rights->societe->lire && $user->rights->societe->creer && $user->rights->kanview->kanview_advance->canuse_prospects)','$conf->kanview->enabled && $conf->societe->enabled',0,'2022-08-17 22:42:31'),(34,'all',1,'kanview','left','kanview',NULL,27,NULL,NULL,700,'/kanview/view/invoices_suppliers_kb.php','','Kanview_LeftMenu_FactureFournisseur_Kanban',NULL,'kanview@kanview',NULL,'((!$conf->global->MAIN_USE_ADVANCED_PERMS) && $conf->kanview->enabled && $user->rights->kanview->canuse && $conf->fournisseur->enabled && $user->rights->fournisseur->facture->lire && $user->rights->fournisseur->facture->creer) || ($conf->global->MAIN_USE_ADVANCED_PERMS && $conf->kanview->enabled && $user->rights->kanview->canuse && $conf->fournisseur->enabled && $user->rights->fournisseur->facture->lire && $user->rights->fournisseur->facture->creer && $user->rights->kanview->kanview_advance->canuse_invoices_suppliers && $user->rights->fournisseur->supplier_invoice_advance->validate)','$conf->kanview->enabled && $conf->fournisseur->enabled',0,'2022-08-17 22:42:31'),(35,'all',1,'kanview','left','kanview',NULL,27,NULL,NULL,800,'/kanview/admin/kanview_config.php','_blank','Kanview_LeftMenu_Config',NULL,'kanview@kanview',NULL,'$user->admin','$conf->kanview->enabled && $user->admin',0,'2022-08-17 22:42:31'),(86,'all',1,'agenda','top','agenda',NULL,0,NULL,NULL,86,'/comm/action/index.php','','TMenuAgenda','<span class=\"fas fa-calendar-alt infobox-action paddingright pictofixedwidth\" style=\"\"></span>','agenda',NULL,'$user->rights->agenda->myactions->read || $user->rights->resource->read','$conf->agenda->enabled || $conf->resource->enabled',2,'2023-12-04 18:56:36'),(87,'all',1,'agenda','left','agenda',NULL,86,NULL,NULL,100,'/comm/action/index.php?mainmenu=agenda&amp;leftmenu=agenda','','Actions','<span class=\"fas fa-calendar-alt infobox-action paddingright pictofixedwidth\" style=\"\"></span>','agenda',NULL,'$user->rights->agenda->myactions->read','$conf->agenda->enabled',2,'2023-12-04 18:56:36'),(88,'all',1,'agenda','left','agenda',NULL,87,NULL,NULL,101,'/comm/action/card.php?mainmenu=agenda&amp;leftmenu=agenda&amp;action=create','','NewAction','','commercial',NULL,'($user->rights->agenda->myactions->create||$user->rights->agenda->allactions->create)','$conf->agenda->enabled',2,'2023-12-04 18:56:36'),(89,'all',1,'agenda','left','agenda',NULL,87,NULL,NULL,140,'/comm/action/index.php?action=default&amp;mainmenu=agenda&amp;leftmenu=agenda','','Calendar','','agenda',NULL,'$user->rights->agenda->myactions->read','$conf->agenda->enabled',2,'2023-12-04 18:56:36'),(90,'all',1,'agenda','left','agenda',NULL,89,NULL,NULL,141,'/comm/action/index.php?action=default&amp;mainmenu=agenda&amp;leftmenu=agenda&amp;status=todo&amp;filter=mine','','MenuToDoMyActions','','agenda',NULL,'$user->rights->agenda->myactions->read','$conf->agenda->enabled',2,'2023-12-04 18:56:36'),(91,'all',1,'agenda','left','agenda',NULL,89,NULL,NULL,142,'/comm/action/index.php?action=default&amp;mainmenu=agenda&amp;leftmenu=agenda&amp;status=done&amp;filter=mine','','MenuDoneMyActions','','agenda',NULL,'$user->rights->agenda->myactions->read','$conf->agenda->enabled',2,'2023-12-04 18:56:36'),(92,'all',1,'agenda','left','agenda',NULL,89,NULL,NULL,143,'/comm/action/index.php?action=default&amp;mainmenu=agenda&amp;leftmenu=agenda&amp;status=todo&amp;filtert=-1','','MenuToDoActions','','agenda',NULL,'$user->rights->agenda->allactions->read','$user->rights->agenda->allactions->read',2,'2023-12-04 18:56:36'),(93,'all',1,'agenda','left','agenda',NULL,89,NULL,NULL,144,'/comm/action/index.php?action=default&amp;mainmenu=agenda&amp;leftmenu=agenda&amp;status=done&amp;filtert=-1','','MenuDoneActions','','agenda',NULL,'$user->rights->agenda->allactions->read','$user->rights->agenda->allactions->read',2,'2023-12-04 18:56:36'),(94,'all',1,'agenda','left','agenda',NULL,87,NULL,NULL,110,'/comm/action/list.php?mode=show_list&amp;mainmenu=agenda&amp;leftmenu=agenda','','List','','agenda',NULL,'$user->rights->agenda->myactions->read','$conf->agenda->enabled',2,'2023-12-04 18:56:36'),(95,'all',1,'agenda','left','agenda',NULL,94,NULL,NULL,111,'/comm/action/list.php?mode=show_list&amp;mainmenu=agenda&amp;leftmenu=agenda&amp;status=todo&amp;filter=mine','','MenuToDoMyActions','','agenda',NULL,'$user->rights->agenda->myactions->read','$conf->agenda->enabled',2,'2023-12-04 18:56:36'),(96,'all',1,'agenda','left','agenda',NULL,94,NULL,NULL,112,'/comm/action/list.php?mode=show_list&amp;mainmenu=agenda&amp;leftmenu=agenda&amp;status=done&amp;filter=mine','','MenuDoneMyActions','','agenda',NULL,'$user->rights->agenda->myactions->read','$conf->agenda->enabled',2,'2023-12-04 18:56:36'),(97,'all',1,'agenda','left','agenda',NULL,94,NULL,NULL,113,'/comm/action/list.php?mode=show_list&amp;mainmenu=agenda&amp;leftmenu=agenda&amp;status=todo&amp;filtert=-1','','MenuToDoActions','','agenda',NULL,'$user->rights->agenda->allactions->read','$user->rights->agenda->allactions->read',2,'2023-12-04 18:56:36'),(98,'all',1,'agenda','left','agenda',NULL,94,NULL,NULL,114,'/comm/action/list.php?mode=show_list&amp;mainmenu=agenda&amp;leftmenu=agenda&amp;status=done&amp;filtert=-1','','MenuDoneActions','','agenda',NULL,'$user->rights->agenda->allactions->read','$user->rights->agenda->allactions->read',2,'2023-12-04 18:56:36'),(99,'all',1,'agenda','left','agenda',NULL,87,NULL,NULL,160,'/comm/action/rapport/index.php?mainmenu=agenda&amp;leftmenu=agenda','','Reportings','','agenda',NULL,'$user->rights->agenda->allactions->read','$conf->agenda->enabled',2,'2023-12-04 18:56:36'),(100,'all',1,'agenda','left','agenda',NULL,87,NULL,NULL,170,'/categories/index.php?mainmenu=agenda&amp;leftmenu=agenda&type=10','','Categories','','agenda',NULL,'$user->rights->agenda->allactions->read','$conf->categorie->enabled',2,'2023-12-04 18:56:36'),(101,'all',1,'ecm','top','ecm',NULL,0,NULL,NULL,82,'/ecm/index.php','','MenuECM','<span class=\"fas fa-folder-open paddingright pictofixedwidth\" style=\"\"></span>','ecm',NULL,'$user->rights->ecm->read || $user->rights->ecm->upload || $user->rights->ecm->setup','$conf->ecm->enabled',2,'2023-12-04 18:56:37'),(102,'all',1,'ecm','left','ecm','ecm',-1,'ecm',NULL,101,'/ecm/index.php?mainmenu=ecm&leftmenu=ecm','','ECMArea','<span class=\"fas fa-folder-open paddingright pictofixedwidth\" style=\"\"></span>','ecm',NULL,'$user->rights->ecm->read || $user->rights->ecm->upload','$user->rights->ecm->read || $user->rights->ecm->upload',2,'2023-12-04 18:56:37'),(103,'all',1,'ecm','left','ecm','ecm_manual',-1,'ecm','ecm',102,'/ecm/index.php?action=file_manager&mainmenu=ecm&leftmenu=ecm','','ECMSectionsManual','','ecm',NULL,'$user->rights->ecm->read || $user->rights->ecm->upload','$user->rights->ecm->read || $user->rights->ecm->upload',2,'2023-12-04 18:56:37'),(104,'all',1,'ecm','left','ecm',NULL,-1,'ecm','ecm',103,'/ecm/index_auto.php?action=file_manager&mainmenu=ecm&leftmenu=ecm','','ECMSectionsAuto','','ecm',NULL,'$user->rights->ecm->read || $user->rights->ecm->upload','($user->rights->ecm->read || $user->rights->ecm->upload) && getDolGlobalInt(\"ECM_AUTO_TREE_ENABLED\")',2,'2023-12-04 18:56:37'),(105,'all',1,'ecm','left','ecm',NULL,-1,'ecm','ecm',104,'/ecm/index_medias.php?action=file_manager&mainmenu=ecm&leftmenu=ecm','','ECMSectionsMedias','','ecm',NULL,'$user->rights->ecm->read || $user->rights->ecm->upload','($user->rights->ecm->read || $user->rights->ecm->upload) && getDolGlobalInt(\"MAIN_FEATURES_LEVEL\") == 2',2,'2023-12-04 18:56:37'),(106,'all',1,'ticket','left','ticket','ticket',-1,'ticket',NULL,101,'/ticket/index.php','','Ticket','<span class=\"fas fa-ticket-alt infobox-contrat paddingright pictofixedwidth em092\" style=\"\"></span>','ticket',NULL,'$user->rights->ticket->read','$conf->ticket->enabled',2,'2023-12-04 18:56:39'),(107,'all',1,'ticket','left','ticket',NULL,-1,'ticket','ticket',102,'/ticket/card.php?action=create','','NewTicket','','ticket',NULL,'$user->rights->ticket->write','$conf->ticket->enabled',2,'2023-12-04 18:56:39'),(108,'all',1,'ticket','left','ticket','ticketlist',-1,'ticket','ticket',103,'/ticket/list.php?search_fk_status=non_closed','','List','','ticket',NULL,'$user->rights->ticket->read','$conf->ticket->enabled',2,'2023-12-04 18:56:39'),(109,'all',1,'ticket','left','ticket','ticketmy',-1,'ticket','ticket',105,'/ticket/list.php?mode=mine&search_fk_status=non_closed','','MenuTicketMyAssign','','ticket',NULL,'$user->rights->ticket->read','$conf->ticket->enabled',0,'2023-12-04 18:56:39'),(110,'all',1,'ticket','left','ticket',NULL,-1,'ticket','ticket',107,'/ticket/stats/index.php','','Statistics','','ticket',NULL,'$user->rights->ticket->read','$conf->ticket->enabled',0,'2023-12-04 18:56:39'),(111,'all',1,'ticket','left','ticket',NULL,-1,'ticket','ticket',107,'/categories/index.php?type=12','','Categories','','ticket',NULL,'$user->rights->ticket->read','$conf->categorie->enabled',0,'2023-12-04 18:56:39');
...
--
-- Table structure for table `llxas_mrp_production_extrafields`
--

DROP TABLE IF EXISTS `llxas_mrp_production_extrafields`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `llxas_mrp_production_extrafields` (
  `rowid` int(11) NOT NULL AUTO_INCREMENT,
  `tms` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `fk_object` int(11) NOT NULL,
  `import_key` varchar(14) DEFAULT NULL,
...
--
-- Dumping data for table `llxas_mrp_production_extrafields`
--

LOCK TABLES `llxas_mrp_production_extrafields` WRITE;
/*!40000 ALTER TABLE `llxas_mrp_production_extrafields` DISABLE KEYS */;
/*!40000 ALTER TABLE `llxas_mrp_production_extrafields` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `llxas_prelevement`
--

DROP TABLE IF EXISTS `llxas_prelevement`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `llxas_prelevement` (
  `rowid` int(11) NOT NULL AUTO_INCREMENT,
  `fk_facture` int(11) DEFAULT NULL,
...
--
-- Dumping data for table `llxas_prelevement`
--

LOCK TABLES `llxas_prelevement` WRITE;
/*!40000 ALTER TABLE `llxas_prelevement` DISABLE KEYS */;
/*!40000 ALTER TABLE `llxas_prelevement` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `llxas_prelevement_demande`
--

DROP TABLE IF EXISTS `llxas_prelevement_demande`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `llxas_prelevement_demande` (
  `rowid` int(11) NOT NULL AUTO_INCREMENT,
  `entity` int(11) NOT NULL DEFAULT 1,
  `fk_facture` int(11) DEFAULT NULL,
  `fk_facture_fourn` int(11) DEFAULT NULL,
...
--
-- Dumping data for table `llxas_prelevement_demande`
--

LOCK TABLES `llxas_prelevement_demande` WRITE;
/*!40000 ALTER TABLE `llxas_prelevement_demande` DISABLE KEYS */;
/*!40000 ALTER TABLE `llxas_prelevement_demande` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `llxas_reports_config` (
  `rowid` int(11) NOT NULL AUTO_INCREMENT,
  `entity` int(11) NOT NULL DEFAULT 1,
  `type_field` varchar(60) DEFAULT NULL,
...
INSERT INTO `llxas_rights_def` (`id`, `libelle`, `module`, `module_position`, `family_position`, `entity`, `perms`, `subperms`, `type`, `bydefault`, `tms`) VALUES (11,'Read invoices','facture',11,0,1,'lire',NULL,'a',0,'2024-01-24 00:16:09'),(12,'Create and update invoices','facture',11,0,1,'creer',NULL,'a',0,'2024-01-24 00:16:09'),(13,'Devalidate invoices','facture',11,0,1,'invoice_advance','unvalidate','a',0,'2024-01-24 00:16:09'),(14,'Validate invoices','facture',11,0,1,'invoice_advance','validate','a',0,'2024-01-24 00:16:09'),(15,'Send invoices by email','facture',11,0,1,'invoice_advance','send','a',0,'2024-01-24 00:16:09'),(16,'Issue payments on invoices','facture',11,0,1,'paiement',NULL,'a',0,'2024-01-24 00:16:09'),(19,'Delete invoices','facture',11,0,1,'supprimer',NULL,'a',0,'2024-01-24 00:16:09'),(21,'Read commercial proposals','propale',10,0,1,'lire',NULL,'r',0,'2023-12-04 18:56:31'),(22,'Create and update commercial proposals','propale',10,0,1,'creer',NULL,'w',0,'2023-12-04 18:56:31'),(24,'Validate commercial proposals','propale',10,0,1,'propal_advance','validate','d',0,'2023-12-04 18:56:31'),(25,'Send commercial proposals to customers','propale',10,0,1,'propal_advance','send','d',0,'2023-12-04 18:56:31'),(26,'Close commercial proposals','propale',10,0,1,'cloturer',NULL,'d',0,'2023-12-04 18:56:31'),(27,'Delete commercial proposals','propale',10,0,1,'supprimer',NULL,'d',0,'2023-12-04 18:56:31'),(28,'Exporting commercial proposals and attributes','propale',10,0,1,'export',NULL,'r',0,'2023-12-04 18:56:31'),(31,'Read products','produit',26,0,1,'lire',NULL,'r',0,'2023-12-04 18:56:31'),(32,'Create/modify products','produit',26,0,1,'creer',NULL,'w',0,'2023-12-04 18:56:31'),(34,'Delete products','produit',26,0,1,'supprimer',NULL,'d',0,'2023-12-04 18:56:31'),(38,'Export products','produit',26,0,1,'export',NULL,'r',0,'2023-12-04 18:56:31'),(39,'Ignore minimum price','produit',26,0,1,'ignore_price_min_advance',NULL,'r',0,'2023-12-04 18:56:31'),(61,'Lire les fiches d\'intervention','ficheinter',41,0,1,'lire',NULL,'r',0,'2023-12-04 18:56:31'),(62,'Creer/modifier les fiches d\'intervention','ficheinter',41,0,1,'creer',NULL,'w',0,'2023-12-04 18:56:31'),(64,'Supprimer les fiches d\'intervention','ficheinter',41,0,1,'supprimer',NULL,'d',0,'2023-12-04 18:56:31'),(67,'Exporter les fiches interventions','ficheinter',41,0,1,'export',NULL,'r',0,'2023-12-04 18:56:31'),(68,'Envoyer les fiches d\'intervention par courriel','ficheinter',41,0,1,'ficheinter_advance','send','r',0,'2023-12-04 18:56:31'),(69,'Valider les fiches d\'intervention ','ficheinter',41,0,1,'ficheinter_advance','validate','a',0,'2023-12-04 18:56:31'),(70,'Dévalider les fiches d\'intervention','ficheinter',41,0,1,'ficheinter_advance','unvalidate','a',0,'2023-12-04 18:56:31'),(81,'Read sales orders','commande',11,0,1,'lire',NULL,'r',0,'2024-01-24 00:16:09'),(82,'Creeat/modify sales orders','commande',11,0,1,'creer',NULL,'w',0,'2024-01-24 00:16:09'),(84,'Validate sales orders','commande',11,0,1,'order_advance','validate','d',0,'2024-01-24 00:16:09'),(85,'Generate the documents sales orders','commande',11,0,1,'order_advance','generetedoc','d',0,'2024-01-24 00:16:09'),(86,'Send sales orders by email','commande',11,0,1,'order_advance','send','d',0,'2024-01-24 00:16:09'),(87,'Close sale orders','commande',11,0,1,'order_advance','close','d',0,'2024-01-24 00:16:09'),(88,'Cancel sale orders','commande',11,0,1,'order_advance','annuler','d',0,'2024-01-24 00:16:09'),(89,'Delete sales orders','commande',11,0,1,'supprimer',NULL,'d',0,'2024-01-24 00:16:09'),(91,'Lire les charges','tax',50,0,1,'charges','lire','r',0,'2023-12-04 18:56:31'),(92,'Creer/modifier les charges','tax',50,0,1,'charges','creer','w',0,'2023-12-04 18:56:31'),(93,'Supprimer les charges','tax',50,0,1,'charges','supprimer','d',0,'2023-12-04 18:56:31'),(94,'Exporter les charges','tax',50,0,1,'charges','export','r',0,'2023-12-04 18:56:31'),(101,'Lire les expeditions','expedition',40,0,1,'lire',NULL,'r',0,'2023-12-04 18:56:31'),(102,'Creer modifier les expeditions','expedition',40,0,1,'creer',NULL,'w',0,'2023-12-04 18:56:31'),(104,'Valider les expeditions','expedition',40,0,1,'shipping_advance','validate','d',0,'2023-12-04 18:56:31'),(105,'Envoyer les expeditions aux clients','expedition',40,0,1,'shipping_advance','send','d',0,'2023-12-04 18:56:31'),(106,'Exporter les expeditions','expedition',40,0,1,'shipment','export','r',0,'2023-12-04 18:56:31'),(109,'Supprimer les expeditions','expedition',40,0,1,'supprimer',NULL,'d',0,'2023-12-04 18:56:31'),(111,'Read bank account and transactions','banque',51,0,1,'lire',NULL,'r',0,'2024-01-24 00:16:09'),(112,'Creer/modifier montant/supprimer ecriture bancaire','banque',51,0,1,'modifier',NULL,'w',0,'2024-01-24 00:16:09'),(113,'Configurer les comptes bancaires (creer, gerer categories)','banque',51,0,1,'configurer',NULL,'a',0,'2024-01-24 00:16:09'),(114,'Rapprocher les ecritures bancaires','banque',51,0,1,'consolidate',NULL,'w',0,'2024-01-24 00:16:09'),(115,'Exporter transactions et releves','banque',51,0,1,'export',NULL,'r',0,'2024-01-24 00:16:09'),(116,'Virements entre comptes','banque',51,0,1,'transfer',NULL,'w',0,'2024-01-24 00:16:09'),(117,'Gerer les envois de cheques','banque',51,0,1,'cheque',NULL,'w',0,'2024-01-24 00:16:09'),(121,'Read third parties','societe',9,0,1,'lire',NULL,'r',0,'2024-01-24 00:16:09'),(122,'Create and update third parties','societe',9,0,1,'creer',NULL,'w',0,'2024-01-24 00:16:09'),(125,'Delete third parties','societe',9,0,1,'supprimer',NULL,'d',0,'2024-01-24 00:16:09'),(126,'Export third parties','societe',9,0,1,'export',NULL,'r',0,'2024-01-24 00:16:09'),(130,'Modify thirdparty information payment','societe',9,0,1,'thirdparty_paymentinformation_advance','write','w',0,'2024-01-24 00:16:09'),(151,'Read direct debit payment orders','prelevement',52,0,1,'bons','lire','r',0,'2023-12-04 18:56:31'),(152,'Create/modify a direct debit payment order','prelevement',52,0,1,'bons','creer','w',0,'2023-12-04 18:56:31'),(153,'Send/Transmit direct debit payment orders','prelevement',52,0,1,'bons','send','a',0,'2023-12-04 18:56:31'),(154,'Record Credits/Rejects of direct debit payment orders','prelevement',52,0,1,'bons','credit','a',0,'2023-12-04 18:56:31'),(161,'Lire les contrats','contrat',41,0,1,'lire',NULL,'r',0,'2023-12-04 18:56:31'),(162,'Creer / modifier les contrats','contrat',41,0,1,'creer',NULL,'w',0,'2023-12-04 18:56:31'),(163,'Activer un service d\'un contrat','contrat',41,0,1,'activer',NULL,'w',0,'2023-12-04 18:56:31'),(164,'Desactiver un service d\'un contrat','contrat',41,0,1,'desactiver',NULL,'w',0,'2023-12-04 18:56:31'),(165,'Supprimer un contrat','contrat',41,0,1,'supprimer',NULL,'d',0,'2023-12-04 18:56:31'),(167,'Export contracts','contrat',41,0,1,'export',NULL,'r',0,'2023-12-04 18:56:31'),(241,'Lire les categories','categorie',20,0,1,'lire',NULL,'r',0,'2023-12-04 18:56:31'),(242,'Creer/modifier les categories','categorie',20,0,1,'creer',NULL,'w',0,'2023-12-04 18:56:31'),(243,'Supprimer les categories','categorie',20,0,1,'supprimer',NULL,'d',0,'2023-12-04 18:56:31'),(251,'Read information of other users, groups and permissions','user',5,0,1,'user','lire','r',0,'2024-01-24 00:16:10'),(252,'Read permissions of other users','user',5,0,1,'user_advance','readperms','r',0,'2024-01-24 00:16:10'),(253,'Create/modify internal and external users, groups and permissions','user',5,0,1,'user','creer','w',0,'2024-01-24 00:16:10'),(254,'Create/modify external users only','user',5,0,1,'user_advance','write','w',0,'2024-01-24 00:16:10'),(255,'Modify the password of other users','user',5,0,1,'user','password','w',0,'2024-01-24 00:16:10'),(256,'Delete or disable other users','user',5,0,1,'user','supprimer','d',0,'2024-01-24 00:16:10'),(262,'Read all third parties (and their objects) by internal users (otherwise only if commercial contact). Not effective for external users (limited to themselves).','societe',9,0,1,'client','voir','r',0,'2024-01-24 00:16:09'),(281,'Read contacts','societe',9,0,1,'contact','lire','r',0,'2024-01-24 00:16:09'),(282,'Create and update contact','societe',9,0,1,'contact','creer','w',0,'2024-01-24 00:16:09'),(283,'Delete contacts','societe',9,0,1,'contact','supprimer','d',0,'2024-01-24 00:16:09'),(286,'Export contacts','societe',9,0,1,'contact','export','d',0,'2024-01-24 00:16:09'),(331,'Lire les bookmarks','bookmark',50,0,1,'lire',NULL,'r',0,'2023-12-04 18:56:31'),(332,'Creer/modifier les bookmarks','bookmark',50,0,1,'creer',NULL,'r',0,'2023-12-04 18:56:31'),(333,'Supprimer les bookmarks','bookmark',50,0,1,'supprimer',NULL,'r',0,'2023-12-04 18:56:31'),(341,'Read its own permissions','user',5,0,1,'self_advance','readperms','r',0,'2024-01-24 00:16:10'),(342,'Create/modify of its own user','user',5,0,1,'self','creer','w',0,'2024-01-24 00:16:10'),(343,'Modify its own password','user',5,0,1,'self','password','w',0,'2024-01-24 00:16:10'),(344,'Modify its own permissions','user',5,0,1,'self_advance','writeperms','w',0,'2024-01-24 00:16:10'),(351,'Read groups','user',5,0,1,'group_advance','read','r',0,'2024-01-24 00:16:10'),(352,'Read permissions of groups','user',5,0,1,'group_advance','readperms','r',0,'2024-01-24 00:16:10'),(353,'Create/modify groups and permissions','user',5,0,1,'group_advance','write','w',0,'2024-01-24 00:16:10'),(354,'Delete groups','user',5,0,1,'group_advance','delete','d',0,'2024-01-24 00:16:10'),(358,'Export all users','user',5,0,1,'user','export','r',0,'2024-01-24 00:16:10'),(511,'Read employee salaries and payments (yours and your subordinates)','salaries',50,0,1,'read',NULL,'r',0,'2024-01-24 00:16:09'),(512,'Create/modify payments of empoyee salaries','salaries',50,0,1,'write',NULL,'w',0,'2024-01-24 00:16:09'),(514,'Delete payments of employee salary','salaries',50,0,1,'delete',NULL,'d',0,'2024-01-24 00:16:09'),(517,'Read salaries and payments of all employees','salaries',50,0,1,'readall',NULL,'r',0,'2024-01-24 00:16:09'),(519,'Export payments of employee salaries','salaries',50,0,1,'export',NULL,'r',0,'2024-01-24 00:16:09'),(531,'Read services','service',29,0,1,'lire',NULL,'r',0,'2024-01-24 00:16:09'),(532,'Create/modify services','service',29,0,1,'creer',NULL,'w',0,'2024-01-24 00:16:09'),(533,'Read prices services','service',29,0,1,'service_advance','read_prices','w',0,'2024-01-24 00:16:09'),(534,'Delete les services','service',29,0,1,'supprimer',NULL,'d',0,'2024-01-24 00:16:09'),(538,'Export services','service',29,0,1,'export',NULL,'r',0,'2024-01-24 00:16:09'),(561,'Read bank transfer payment orders','paymentbybanktransfer',52,0,1,'read',NULL,'r',0,'2023-12-04 18:56:31'),(562,'Create/modify a bank transfer payment order','paymentbybanktransfer',52,0,1,'create',NULL,'w',0,'2023-12-04 18:56:31'),(563,'Send/Transmit bank transfer payment order','paymentbybanktransfer',52,0,1,'send',NULL,'a',0,'2023-12-04 18:56:31'),(564,'Record Debits/Rejects of bank transfer payment order','paymentbybanktransfer',52,0,1,'debit',NULL,'a',0,'2023-12-04 18:56:31'),(651,'Read bom of Bom','bom',65,0,1,'read',NULL,'w',0,'2024-01-24 00:16:09'),(652,'Create/Update bom of Bom','bom',65,0,1,'write',NULL,'w',0,'2024-01-24 00:16:09'),(653,'Delete bom of Bom','bom',65,0,1,'delete',NULL,'w',0,'2024-01-24 00:16:09'),(661,'Read Manufacturing Order','mrp',66,0,1,'read',NULL,'w',0,'2024-01-24 00:16:09'),(662,'Create/Update Manufacturing Order','mrp',66,0,1,'write',NULL,'w',0,'2024-01-24 00:16:09'),(663,'Delete Manufacturing Order','mrp',66,0,1,'delete',NULL,'w',0,'2024-01-24 00:16:09'),(771,'Read expense reports (yours and your subordinates)','expensereport',42,0,1,'lire',NULL,'r',0,'2024-01-24 00:16:09'),(772,'Create/modify expense reports','expensereport',42,0,1,'creer',NULL,'w',0,'2024-01-24 00:16:09'),(773,'Delete expense reports','expensereport',42,0,1,'supprimer',NULL,'d',0,'2024-01-24 00:16:09'),(775,'Approve expense reports','expensereport',42,0,1,'approve',NULL,'w',0,'2024-01-24 00:16:09'),(776,'Pay expense reports','expensereport',42,0,1,'to_paid',NULL,'w',0,'2024-01-24 00:16:09'),(777,'Read expense reports of everybody','expensereport',42,0,1,'readall',NULL,'r',0,'2024-01-24 00:16:09'),(778,'Create expense reports for everybody','expensereport',42,0,1,'writeall_advance',NULL,'w',0,'2024-01-24 00:16:09'),(779,'Export expense reports','expensereport',42,0,1,'export',NULL,'r',0,'2024-01-24 00:16:09'),(1001,'Lire les stocks','stock',39,0,1,'lire',NULL,'r',0,'2023-12-04 18:56:31'),(1002,'Creer/Modifier les stocks','stock',39,0,1,'creer',NULL,'w',0,'2023-12-04 18:56:31'),(1003,'Supprimer les stocks','stock',39,0,1,'supprimer',NULL,'d',0,'2023-12-04 18:56:31'),(1004,'Lire mouvements de stocks','stock',39,0,1,'mouvement','lire','r',0,'2023-12-04 18:56:31'),(1005,'Creer/modifier mouvements de stocks','stock',39,0,1,'mouvement','creer','w',0,'2023-12-04 18:56:31'),(1011,'inventoryReadPermission','stock',39,0,1,'inventory_advance','read','w',0,'2023-12-04 18:56:31'),(1012,'inventoryCreatePermission','stock',39,0,1,'inventory_advance','write','w',0,'2023-12-04 18:56:31'),(1101,'Read delivery receipts','expedition',40,0,1,'delivery','lire','r',0,'2023-12-04 18:56:31'),(1102,'Create/modify delivery receipts','expedition',40,0,1,'delivery','creer','w',0,'2023-12-04 18:56:31'),(1104,'Validate delivery receipts','expedition',40,0,1,'delivery_advance','validate','d',0,'2023-12-04 18:56:31'),(1109,'Delete delivery receipts','expedition',40,0,1,'delivery','supprimer','d',0,'2023-12-04 18:56:31'),(1181,'Consulter les fournisseurs','fournisseur',12,0,1,'lire',NULL,'r',0,'2024-01-24 00:16:09'),(1182,'Consulter les commandes fournisseur','fournisseur',12,0,1,'commande','lire','r',0,'2024-01-24 00:16:09'),(1183,'Creer une commande fournisseur','fournisseur',12,0,1,'commande','creer','w',0,'2024-01-24 00:16:09'),(1184,'Valider une commande fournisseur','fournisseur',12,0,1,'supplier_order_advance','validate','w',0,'2024-01-24 00:16:09'),(1185,'Approuver une commande fournisseur','fournisseur',12,0,1,'commande','approuver','w',0,'2024-01-24 00:16:09'),(1186,'Commander une commande fournisseur','fournisseur',12,0,1,'commande','commander','w',0,'2024-01-24 00:16:09'),(1187,'Receptionner une commande fournisseur','fournisseur',12,0,1,'commande','receptionner','d',0,'2024-01-24 00:16:09'),(1188,'Supprimer une commande fournisseur','fournisseur',12,0,1,'commande','supprimer','d',0,'2024-01-24 00:16:09'),(1189,'Check/Uncheck a supplier order reception','fournisseur',12,0,1,'commande_advance','check','w',0,'2024-01-24 00:16:09'),(1191,'Exporter les commande fournisseurs, attributs','fournisseur',12,0,1,'commande','export','r',0,'2024-01-24 00:16:09'),(1201,'Lire les exports','export',72,0,1,'lire',NULL,'r',0,'2023-12-04 18:56:31'),(1202,'Creer/modifier un export','export',72,0,1,'creer',NULL,'w',0,'2023-12-04 18:56:31'),(1231,'Consulter les factures fournisseur','fournisseur',12,0,1,'facture','lire','r',0,'2024-01-24 00:16:09'),(1232,'Creer une facture fournisseur','fournisseur',12,0,1,'facture','creer','w',0,'2024-01-24 00:16:09'),(1233,'Valider une facture fournisseur','fournisseur',12,0,1,'supplier_invoice_advance','validate','w',0,'2024-01-24 00:16:09'),(1234,'Supprimer une facture fournisseur','fournisseur',12,0,1,'facture','supprimer','d',0,'2024-01-24 00:16:09'),(1235,'Envoyer les factures par mail','fournisseur',12,0,1,'supplier_invoice_advance','send','a',0,'2024-01-24 00:16:09'),(1236,'Exporter les factures fournisseurs, attributs et reglements','fournisseur',12,0,1,'facture','export','r',0,'2024-01-24 00:16:09'),(1251,'Run mass imports of external data (data load)','import',70,0,1,'run',NULL,'r',0,'2023-12-04 18:56:31'),(1321,'Export customer invoices, attributes and payments','facture',11,0,1,'facture','export','r',0,'2024-01-24 00:16:09'),(1322,'Re-open a fully paid invoice','facture',11,0,1,'invoice_advance','reopen','r',0,'2024-01-24 00:16:09'),(1421,'Export sales orders and attributes','commande',11,0,1,'commande','export','r',0,'2024-01-24 00:16:09'),(2401,'Read actions/tasks linked to his account','agenda',15,0,1,'myactions','read','r',0,'2024-01-24 00:16:09'),(2402,'Create/modify actions/tasks linked to his account','agenda',15,0,1,'myactions','create','w',0,'2024-01-24 00:16:09'),(2403,'Delete actions/tasks linked to his account','agenda',15,0,1,'myactions','delete','w',0,'2024-01-24 00:16:09'),(2411,'Read actions/tasks of others','agenda',15,0,1,'allactions','read','r',0,'2024-01-24 00:16:09'),(2412,'Create/modify actions/tasks of others','agenda',15,0,1,'allactions','create','w',0,'2024-01-24 00:16:09'),(2413,'Delete actions/tasks of others','agenda',15,0,1,'allactions','delete','w',0,'2024-01-24 00:16:09'),(2414,'Export actions/tasks of others','agenda',15,0,1,'export',NULL,'w',0,'2024-01-24 00:16:09'),(2501,'Read or download documents','ecm',10,0,1,'read',NULL,'r',0,'2024-01-24 00:16:09'),(2503,'Upload a document','ecm',10,0,1,'upload',NULL,'w',0,'2024-01-24 00:16:09'),(2515,'Administer directories of documents','ecm',10,0,1,'setup',NULL,'w',0,'2024-01-24 00:16:09'),(2610,'Générer / modifier la clé API des utilisateurs','api',24,0,1,'apikey','generate','w',0,'2023-12-04 18:56:31'),(20001,'Read leave requests (yours and your subordinates)','holiday',42,0,1,'read',NULL,'w',0,'2024-01-24 00:16:09'),(20002,'Create/modify leave requests','holiday',42,0,1,'write',NULL,'w',0,'2024-01-24 00:16:09'),(20003,'Delete leave requests','holiday',42,0,1,'delete',NULL,'w',0,'2024-01-24 00:16:09'),(20004,'Read leave requests for everybody','holiday',42,0,1,'readall',NULL,'w',0,'2024-01-24 00:16:09'),(20005,'Create/modify leave requests for everybody','holiday',42,0,1,'writeall',NULL,'w',0,'2024-01-24 00:16:09'),(20006,'Setup leave requests of users (setup and update balance)','holiday',42,0,1,'define_holiday',NULL,'w',0,'2024-01-24 00:16:09'),(20007,'Approve leave requests','holiday',42,0,1,'approve',NULL,'w',0,'2024-01-24 00:16:09'),(50401,'Bind products and invoices with accounting accounts','accounting',61,0,1,'bind','write','r',0,'2023-12-04 18:56:31'),(50411,'Read operations in Ledger','accounting',61,0,1,'mouvements','lire','r',0,'2023-12-04 18:56:31'),(50412,'Write/Edit operations in Ledger','accounting',61,0,1,'mouvements','creer','w',0,'2023-12-04 18:56:31'),(50414,'Delete operations in Ledger','accounting',61,0,1,'mouvements','supprimer','d',0,'2023-12-04 18:56:31'),(50415,'Delete all operations by year and journal in Ledger','accounting',61,0,1,'mouvements','supprimer_tous','d',0,'2023-12-04 18:56:31'),(50418,'Export operations of the Ledger','accounting',61,0,1,'mouvements','export','r',0,'2023-12-04 18:56:31'),(50420,'Report and export reports (turnover, balance, journals, ledger)','accounting',61,0,1,'comptarapport','lire','r',0,'2023-12-04 18:56:31'),(50430,'Manage fiscal periods, validate movements and close periods','accounting',61,0,1,'fiscalyear','write','r',0,'2023-12-04 18:56:31'),(50440,'Manage chart of accounts, setup of accountancy','accounting',61,0,1,'chartofaccount',NULL,'r',0,'2023-12-04 18:56:31'),(56001,'Read ticket','ticket',60,0,1,'read',NULL,'r',0,'2024-01-24 00:16:10'),(56002,'Create les tickets','ticket',60,0,1,'write',NULL,'w',0,'2024-01-24 00:16:10'),(56003,'Delete les tickets','ticket',60,0,1,'delete',NULL,'d',0,'2024-01-24 00:16:10'),(56004,'Manage tickets','ticket',60,0,1,'manage',NULL,'w',0,'2024-01-24 00:16:10'),(513001,'Export list','listexportimport',100050,0,1,'export',NULL,'r',1,'2023-12-04 18:56:31'),(513002,'Import list','listexportimport',100050,0,1,'import',NULL,'m',0,'2023-12-04 18:56:31'),(520567,'Read unidadalt of UnidadMedida','unidadmedida',0,0,1,'read',NULL,'w',1,'2023-12-04 18:56:31'),(520568,'Create/Update unidadalt of UnidadMedida','unidadmedida',0,0,1,'write',NULL,'w',1,'2023-12-04 18:56:31'),(520569,'Delete unidadalt of UnidadMedida','unidadmedida',0,0,1,'delete',NULL,'w',1,'2023-12-04 18:56:31'),(577889,'Read objects of Unboxutil','unboxutil',100090,0,1,'myobject','read','w',0,'2023-12-04 18:56:31'),(577890,'Create/Update objects of Unboxutil','unboxutil',100090,0,1,'myobject','write','w',0,'2023-12-04 18:56:31'),(577891,'Delete objects of Unboxutil','unboxutil',100090,0,1,'myobject','delete','w',0,'2023-12-04 18:56:31'),(941601,'Lire les receptions','reception',40,0,1,'lire',NULL,'r',0,'2023-12-04 18:56:31'),(941602,'Creer modifier les receptions','reception',40,0,1,'creer',NULL,'w',0,'2023-12-04 18:56:31'),(941603,'Valider les receptions','reception',40,0,1,'reception_advance','validate','d',0,'2023-12-04 18:56:31'),(941604,'Envoyer les receptions aux clients','reception',40,0,1,'reception_advance','send','d',0,'2023-12-04 18:56:31'),(941605,'Exporter les receptions','reception',40,0,1,'reception','export','r',0,'2023-12-04 18:56:31'),(941606,'Supprimer les receptions','reception',40,0,1,'supprimer',NULL,'d',0,'2023-12-04 18:56:31'),(4000040,'DesignReports','reports',100050,0,1,'admin',NULL,'a',1,'2023-12-04 18:56:31'),(4000041,'UseReports','reports',100050,0,1,'use',NULL,'a',1,'2023-12-04 18:56:31'),(4000042,'ProductsList','reports',100050,0,1,'P001',NULL,'a',1,'2023-12-04 18:56:31'),(4000043,'ProductsStock','reports',100050,0,1,'P002',NULL,'a',1,'2023-12-04 18:56:31'),(4000044,'StockAlert','reports',100050,0,1,'P003',NULL,'a',1,'2023-12-04 18:56:31'),(4000045,'ProductsSales','reports',100050,0,1,'P004',NULL,'a',1,'2023-12-04 18:56:31'),(4000046,'CustomersInvoices','reports',100050,0,1,'P005',NULL,'a',1,'2023-12-04 18:56:31'),(4000047,'CommercialProposals','reports',100050,0,1,'P006',NULL,'a',1,'2023-12-04 18:56:31'),(4000048,'CustomersOrders','reports',100050,0,1,'P007',NULL,'a',1,'2023-12-04 18:56:31'),(4000049,'ThirdParties','reports',100050,0,1,'P008',NULL,'a',1,'2023-12-04 18:56:31'),(40000410,'Contacts','reports',100050,0,1,'P009',NULL,'a',1,'2023-12-04 18:56:31'),(40000411,'SalesSummary','reports',100050,0,1,'P010',NULL,'a',1,'2023-12-04 18:56:31'),(40000412,'BillsSuppliers','reports',100050,0,1,'P011',NULL,'a',1,'2023-12-04 18:56:31'),(40000413,'PurchasesSummary','reports',100050,0,1,'P012',NULL,'a',1,'2023-12-04 18:56:31'),(40000414,'SalesDetails','reports',100050,0,1,'P013',NULL,'a',1,'2023-12-04 18:56:31'),(40000415,'SuppliersOrders','reports',100050,0,1,'P014',NULL,'a',1,'2023-12-04 18:56:31'),(40000416,'SalesTaxDetail','reports',100050,0,1,'P015',NULL,'a',1,'2023-12-04 18:56:31'),(40000417,'PurchasesTaxDetail','reports',100050,0,1,'P016',NULL,'a',1,'2023-12-04 18:56:31'),(40000418,'UndeliveredProducts','reports',100050,0,1,'P017',NULL,'a',1,'2023-12-04 18:56:31'),(40000419,'OrderedProducts','reports',100050,0,1,'P018',NULL,'a',1,'2023-12-04 18:56:31'),(40000420,'Projects','reports',100050,0,1,'P019',NULL,'a',1,'2023-12-04 18:56:31'),(40000421,'MarginByProduct','reports',100050,0,1,'P020',NULL,'a',1,'2023-12-04 18:56:31'),(40000422,'CustomerMargins','reports',100050,0,1,'P021',NULL,'a',1,'2023-12-04 18:56:31'),(40000423,'MarginBySalesRepresentative','reports',100050,0,1,'P022',NULL,'a',1,'2023-12-04 18:56:31'),(40000424,'ActiveContracts','reports',100050,0,1,'P023',NULL,'a',1,'2023-12-04 18:56:31'),(40000425,'ExpiringContracts','reports',100050,0,1,'P024',NULL,'a',1,'2023-12-04 18:56:31'),(40000426,'CashBalance','reports',100050,0,1,'P025',NULL,'a',1,'2023-12-04 18:56:31'),(40000427,'IncomeByCustomer','reports',100050,0,1,'P026',NULL,'a',1,'2023-12-04 18:56:31'),(40000428,'SalesBySalesRepresentative','reports',100050,0,1,'P027',NULL,'a',1,'2023-12-04 18:56:31'),(40000434,'StockValue','reports',100050,0,1,'P033',NULL,'a',1,'2023-12-04 18:56:31'),(40000435,'StockMovements','reports',100050,0,1,'P034',NULL,'a',1,'2023-12-04 18:56:31'),(40000436,'EntryDetails','reports',100050,0,1,'P035',NULL,'a',1,'2023-12-04 18:56:31'),(40000437,'OutputDetails','reports',100050,0,1,'P036',NULL,'a',1,'2023-12-04 18:56:31'),(40000438,'ProposalsNotFirmed','reports',100050,0,1,'P037',NULL,'a',1,'2023-12-04 18:56:31'),(40000439,'CommitmentBalance','reports',100050,0,1,'P038',NULL,'a',1,'2023-12-04 18:56:31'),(40000440,'Interventions','reports',100050,0,1,'P039',NULL,'a',1,'2023-12-04 18:56:31'),(40000441,'InterventionsDetails','reports',100050,0,1,'P040',NULL,'a',1,'2023-12-04 18:56:31'),(40000442,'Agenda','reports',100050,0,1,'P041',NULL,'a',1,'2023-12-04 18:56:31'),(40000443,'ProjectsMargin','reports',100050,0,1,'P042',NULL,'a',1,'2023-12-04 18:56:31'),(40000444,'BatchSales','reports',100050,0,1,'P043',NULL,'a',1,'2023-12-04 18:56:31'),(40000445,'BatchPurchases','reports',100050,0,1,'P044',NULL,'a',1,'2023-12-04 18:56:31'),(40000446,'OutstandingDebits','reports',100050,0,1,'P045',NULL,'a',1,'2023-12-04 18:56:31'),(40000447,'OutcomeBySupplier','reports',100050,0,1,'P046',NULL,'a',1,'2023-12-04 18:56:31'),(40000448,'BankMovements','reports',100050,0,1,'P047',NULL,'a',1,'2023-12-04 18:56:31'),(40000449,'Tasks','reports',100050,0,1,'P048',NULL,'a',1,'2023-12-04 18:56:31'),(40000450,'SocialCharges','reports',100050,0,1,'P049',NULL,'a',1,'2023-12-04 18:56:31'),(40000451,'Holidays','reports',100050,0,1,'P050',NULL,'a',1,'2023-12-04 18:56:31'),(40000452,'Inventory','reports',100050,0,1,'P051',NULL,'a',1,'2023-12-04 18:56:31'),(40000453,'ListOfStockMovements','reports',100050,0,1,'P052',NULL,'a',1,'2023-12-04 18:56:31'),(40000454,'ShelledProducts','reports',100050,0,1,'P053',NULL,'a',1,'2023-12-04 18:56:31'),(40000455,'BatchStock','reports',100050,0,1,'P054',NULL,'a',1,'2023-12-04 18:56:31'),(40000456,'Modelo347','reports',100050,0,1,'P055',NULL,'a',1,'2023-12-04 18:56:31'),(40000457,'VariantsStock','reports',100050,0,1,'P056',NULL,'a',1,'2023-12-04 18:56:31'),(40000458,'VariantsSales','reports',100050,0,1,'P057',NULL,'a',1,'2023-12-04 18:56:31'),(40000460,'Shelled_Products','reports',100050,0,1,'P059',NULL,'a',1,'2023-12-04 18:56:31'),(40000461,'pe_Supplier','reports',100050,0,1,'P060',NULL,'a',1,'2023-12-04 18:56:31'),(40000462,'Tickets','reports',100050,0,1,'P061',NULL,'a',1,'2023-12-04 18:56:31'),(40000474,'Product By Vendor','reports',100050,0,1,'P073',NULL,'a',1,'2024-01-24 00:16:09'),(40000476,'Bom ','reports',100050,0,1,'P075',NULL,'a',1,'2024-01-24 00:16:09'),(125032002,'Rights_CanUseKanview','kanview',100100,0,1,'canuse',NULL,'w',0,'2023-12-04 18:56:31'),(125032003,'Rights_CanUseKanview_Projects','kanview',100100,0,1,'kanview_advance','canuse_projects','w',0,'2023-12-04 18:56:31'),(125032004,'Rights_CanUseKanview_Tasks','kanview',100100,0,1,'kanview_advance','canuse_tasks','w',0,'2023-12-04 18:56:31'),(125032005,'Rights_CanUseKanview_Propals','kanview',100100,0,1,'kanview_advance','canuse_propals','w',0,'2023-12-04 18:56:31'),(125032006,'Rights_CanUseKanview_Orders','kanview',100100,0,1,'kanview_advance','canuse_orders','w',0,'2023-12-04 18:56:31'),(125032007,'Rights_CanUseKanview_Invoices','kanview',100100,0,1,'kanview_advance','canuse_invoices','w',0,'2023-12-04 18:56:31'),(125032008,'Rights_CanUseKanview_Prospects','kanview',100100,0,1,'kanview_advance','canuse_prospects','w',0,'2023-12-04 18:56:31'),(125032009,'Rights_CanUseKanview_InvoicesSuppliers','kanview',100100,0,1,'kanview_advance','canuse_invoices_suppliers','w',0,'2023-12-04 18:56:31');
...
--
-- Table structure for table `llxas_unidadmedida_umfactura`
--

DROP TABLE IF EXISTS `llxas_unidadmedida_umfactura`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `llxas_unidadmedida_umfactura` (
  `rowid` int(11) NOT NULL AUTO_INCREMENT,
  `um` int(11) NOT NULL,
  `fk_facture` int(11) NOT NULL,
  `fk_rang` int(11) NOT NULL,
  PRIMARY KEY (`rowid`),
  KEY `idx_unidadmedida_umfactura_rowid` (`rowid`),
  KEY `idx_unidadmedida_umfactura_fk_facture` (`fk_facture`),
  KEY `idx_unidadmedida_umfactura_fk_rang` (`fk_rang`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `llxas_unidadmedida_umfactura`
--

LOCK TABLES `llxas_unidadmedida_umfactura` WRITE;
/*!40000 ALTER TABLE `llxas_unidadmedida_umfactura` DISABLE KEYS */;
/*!40000 ALTER TABLE `llxas_unidadmedida_umfactura` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `llxas_unidadmedida_umfactura_extrafields`
--

DROP TABLE IF EXISTS `llxas_unidadmedida_umfactura_extrafields`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `llxas_unidadmedida_umfactura_extrafields` (
  `rowid` int(11) NOT NULL AUTO_INCREMENT,
  `tms` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `fk_object` int(11) NOT NULL,
  `import_key` varchar(14) DEFAULT NULL,
...
--
-- Dumping data for table `llxas_unidadmedida_umfactura_extrafields`
--

LOCK TABLES `llxas_unidadmedida_umfactura_extrafields` WRITE;
/*!40000 ALTER TABLE `llxas_unidadmedida_umfactura_extrafields` DISABLE KEYS */;
/*!40000 ALTER TABLE `llxas_unidadmedida_umfactura_extrafields` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `llxas_unidadmedida_unidadalt`
--

DROP TABLE IF EXISTS `llxas_unidadmedida_unidadalt`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `llxas_unidadmedida_unidadalt` (
  `amount` double(24,8) DEFAULT NULL,
  `tms` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `fk_user_modif` int(11) DEFAULT NULL,
  `fk_c_units_rowid` int(11) NOT NULL,
  `umalt` int(11) NOT NULL,
  `new` tinyint(4) NOT NULL DEFAULT 0,
  PRIMARY KEY (`fk_c_units_rowid`,`umalt`),
  KEY `idx_unidadmedida_unidadalt_fk_c_units_rowid` (`fk_c_units_rowid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `llxas_unidadmedida_unidadalt`
--

LOCK TABLES `llxas_unidadmedida_unidadalt` WRITE;
/*!40000 ALTER TABLE `llxas_unidadmedida_unidadalt` DISABLE KEYS */;
/*!40000 ALTER TABLE `llxas_unidadmedida_unidadalt` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `llxas_unidadmedida_unidadalt_extrafields`
--

DROP TABLE IF EXISTS `llxas_unidadmedida_unidadalt_extrafields`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `llxas_unidadmedida_unidadalt_extrafields` (
  `rowid` int(11) NOT NULL AUTO_INCREMENT,
  `tms` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `fk_object` int(11) NOT NULL,
  `import_key` varchar(14) DEFAULT NULL,
...
--
-- Dumping data for table `llxas_unidadmedida_unidadalt_extrafields`
--

LOCK TABLES `llxas_unidadmedida_unidadalt_extrafields` WRITE;
/*!40000 ALTER TABLE `llxas_unidadmedida_unidadalt_extrafields` DISABLE KEYS */;
/*!40000 ALTER TABLE `llxas_unidadmedida_unidadalt_extrafields` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `llxas_user` (`rowid`, `entity`, `ref_employee`, `ref_ext`, `admin`, `employee`, `fk_establishment`, `datec`, `tms`, `fk_user_creat`, `fk_user_modif`, `login`, `pass_encoding`, `pass`, `pass_crypted`, `pass_temp`, `api_key`, `gender`, `civility`, `lastname`, `firstname`, `address`, `zip`, `town`, `fk_state`, `fk_country`, `birth`, `job`, `office_phone`, `office_fax`, `user_mobile`, `personal_mobile`, `email`, `personal_email`, `signature`, `socialnetworks`, `fk_soc`, `fk_socpeople`, `fk_member`, `fk_user`, `fk_user_expense_validator`, `fk_user_holiday_validator`, `note_public`, `note_private`, `model_pdf`, `datelastlogin`, `datepreviouslogin`, `datelastpassvalidation`, `datestartvalidity`, `dateendvalidity`, `iplastlogin`, `ippreviouslogin`, `egroupware_id`, `ldap_sid`, `openid`, `statut`, `photo`, `lang`, `color`, `barcode`, `fk_barcode_type`, `accountancy_code`, `nb_holiday`, `thm`, `tjm`, `salary`, `salaryextra`, `dateemployment`, `dateemploymentend`, `weeklyhours`, `import_key`, `default_range`, `default_c_exp_tax_cat`, `fk_warehouse`, `national_registration_number`, `birth_place`, `note`) VALUES (1,0,NULL,NULL,1,1,0,'2021-11-10 12:55:49','2023-05-16 20:07:23',NULL,NULL,'admin',NULL,NULL,'$2y$10$pXfAJstW/qOyHwfRtw0YN.yiUMku/lVGlLiU1tqUMF5jsQov1hwI.',NULL,'C50w0ZYdDyR97nI5cdpbIW0HVR2jy80a',NULL,'','SuperAdmin','','','','',NULL,NULL,NULL,'','','','','','','','','[]',NULL,NULL,NULL,NULL,NULL,NULL,'','',NULL,'2024-01-25 12:59:33','2024-01-24 12:06:15',NULL,NULL,NULL,'189.203.88.243','189.203.88.243',NULL,'',NULL,1,NULL,NULL,'',NULL,0,'',0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
...
INSERT INTO `llxas_user_param` (`fk_user`, `entity`, `param`, `value`) VALUES (1,1,'MAIN_SELECTEDFIELDS_productlist','ef.uma,ef.um,p.ref,p.label,p.sellprice,p.tosell,p.tobuy,');
...
INSERT INTO `llxas_user_rights` (`rowid`, `entity`, `fk_user`, `fk_id`) VALUES (7342,1,1,11),(7343,1,1,12),(7344,1,1,13),(7345,1,1,14),(7346,1,1,15),(7347,1,1,16),(7348,1,1,19),(7349,1,1,21),(7350,1,1,22),(7351,1,1,24),(7352,1,1,25),(7353,1,1,26),(7354,1,1,27),(7355,1,1,28),(7356,1,1,31),(7357,1,1,32),(7358,1,1,34),(7359,1,1,38),(7360,1,1,39),(7361,1,1,61),(7362,1,1,62),(7363,1,1,64),(7364,1,1,67),(7365,1,1,68),(7366,1,1,69),(7367,1,1,70),(7368,1,1,81),(7369,1,1,82),(7370,1,1,84),(7371,1,1,85),(7372,1,1,86),(7373,1,1,87),(7374,1,1,88),(7375,1,1,89),(7376,1,1,91),(7377,1,1,92),(7378,1,1,93),(7379,1,1,94),(7380,1,1,101),(7381,1,1,102),(7382,1,1,104),(7383,1,1,105),(7384,1,1,106),(7385,1,1,109),(7386,1,1,111),(7387,1,1,112),(7388,1,1,113),(7389,1,1,114),(7390,1,1,115),(7391,1,1,116),(7392,1,1,117),(7393,1,1,121),(7394,1,1,122),(7395,1,1,125),(7396,1,1,126),(7397,1,1,130),(7398,1,1,151),(7399,1,1,152),(7400,1,1,153),(7401,1,1,154),(7402,1,1,161),(7403,1,1,162),(7404,1,1,163),(7405,1,1,164),(7406,1,1,165),(7407,1,1,167),(7408,1,1,241),(7409,1,1,242),(7410,1,1,243),(7411,1,1,251),(7412,1,1,252),(7413,1,1,253),(7414,1,1,254),(7415,1,1,255),(7416,1,1,256),(7417,1,1,262),(7418,1,1,281),(7419,1,1,282),(7420,1,1,283),(7421,1,1,286),(7422,1,1,331),(7423,1,1,332),(7424,1,1,333),(7425,1,1,341),(7426,1,1,342),(7427,1,1,343),(7428,1,1,344),(7429,1,1,351),(7430,1,1,352),(7431,1,1,353),(7432,1,1,354),(7433,1,1,358),(7434,1,1,511),(7435,1,1,512),(7436,1,1,514),(7437,1,1,517),(7438,1,1,519),(7439,1,1,531),(7440,1,1,532),(7441,1,1,533),(7442,1,1,534),(7443,1,1,538),(7444,1,1,561),(7445,1,1,562),(7446,1,1,563),(7447,1,1,564),(7448,1,1,651),(7449,1,1,652),(7450,1,1,653),(7451,1,1,661),(7452,1,1,662),(7453,1,1,663),(7454,1,1,771),(7455,1,1,772),(7456,1,1,773),(7457,1,1,775),(7458,1,1,776),(7459,1,1,777),(7460,1,1,778),(7461,1,1,779),(7462,1,1,1001),(7463,1,1,1002),(7464,1,1,1003),(7465,1,1,1004),(7466,1,1,1005),(7467,1,1,1011),(7468,1,1,1012),(7469,1,1,1101),(7470,1,1,1102),(7471,1,1,1104),(7472,1,1,1109),(247,1,1,1121),(240,1,1,1122),(242,1,1,1123),(244,1,1,1124),(246,1,1,1125),(248,1,1,1126),(7473,1,1,1181),(7474,1,1,1182),(7475,1,1,1183),(7476,1,1,1184),(7477,1,1,1185),(7478,1,1,1186),(7479,1,1,1187),(7480,1,1,1188),(7481,1,1,1189),(7482,1,1,1191),(7483,1,1,1201),(7484,1,1,1202),(7485,1,1,1231),(7486,1,1,1232),(7487,1,1,1233),(7488,1,1,1234),(7489,1,1,1235),(7490,1,1,1236),(7491,1,1,1251),(7492,1,1,1321),(7493,1,1,1322),(7494,1,1,1421),(7495,1,1,2401),(7496,1,1,2402),(7497,1,1,2403),(7498,1,1,2411),(7499,1,1,2412),(7500,1,1,2413),(7501,1,1,2414),(7502,1,1,2501),(7503,1,1,2503),(7504,1,1,2515),(7505,1,1,2610),(7506,1,1,20001),(7507,1,1,20002),(7508,1,1,20003),(7509,1,1,20004),(7510,1,1,20005),(7511,1,1,20006),(7512,1,1,20007),(7513,1,1,50401),(7514,1,1,50411),(7515,1,1,50412),(7516,1,1,50414),(7517,1,1,50415),(7518,1,1,50418),(7519,1,1,50420),(7520,1,1,50430),(7521,1,1,50440),(7522,1,1,56001),(7523,1,1,56002),(7524,1,1,56003),(7525,1,1,56004),(7526,1,1,513001),(7527,1,1,513002),(7528,1,1,520567),(7529,1,1,520568),(7530,1,1,520569),(296,1,1,577888),(7531,1,1,577889),(7532,1,1,577890),(7533,1,1,577891),(7534,1,1,941601),(7535,1,1,941602),(7536,1,1,941603),(7537,1,1,941604),(7538,1,1,941605),(7539,1,1,941606),(7540,1,1,4000040),(7541,1,1,4000041),(7542,1,1,4000042),(7543,1,1,4000043),(7544,1,1,4000044),(7545,1,1,4000045),(7546,1,1,4000046),(7547,1,1,4000047),(7548,1,1,4000048),(7549,1,1,4000049),(7550,1,1,40000410),(7551,1,1,40000411),(7552,1,1,40000412),(7553,1,1,40000413),(7554,1,1,40000414),(7555,1,1,40000415),(7556,1,1,40000416),(7557,1,1,40000417),(7558,1,1,40000418),(7559,1,1,40000419),(7560,1,1,40000420),(7561,1,1,40000421),(7562,1,1,40000422),(7563,1,1,40000423),(7564,1,1,40000424),(7565,1,1,40000425),(7566,1,1,40000426),(7567,1,1,40000427),(7568,1,1,40000428),(7569,1,1,40000434),(7570,1,1,40000435),(7571,1,1,40000436),(7572,1,1,40000437),(7573,1,1,40000438),(7574,1,1,40000439),(7575,1,1,40000440),(7576,1,1,40000441),(7577,1,1,40000442),(7578,1,1,40000443),(7579,1,1,40000444),(7580,1,1,40000445),(7581,1,1,40000446),(7582,1,1,40000447),(7583,1,1,40000448),(7584,1,1,40000449),(7585,1,1,40000450),(7586,1,1,40000451),(7587,1,1,40000452),(7588,1,1,40000453),(7589,1,1,40000454),(7590,1,1,40000455),(7591,1,1,40000456),(7592,1,1,40000457),(7593,1,1,40000458),(7594,1,1,40000460),(7595,1,1,40000461),(7596,1,1,40000462),(7597,1,1,40000474),(7598,1,1,40000476),(7599,1,1,125032002),(7600,1,1,125032003),(7601,1,1,125032004),(7602,1,1,125032005),(7603,1,1,125032006),(7604,1,1,125032007),(7605,1,1,125032008),(7606,1,1,125032009);
...
-- Dump completed on 2024-01-25 12:59:49
