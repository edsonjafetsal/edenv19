...
$extracss = '';
$extrajs = array(
    '/contact/js/jquery.mask.js',
    '/contact/js/ponenumbermask.js'
);
...
if (is_object($objcanvas) && $objcanvas->displayCanvasExists($action)) {
	...
	if ($user->hasRight('societe', 'contact', 'creer')) {
		if ($action == 'create') {
			...
			print '</td><td><input type="text" class="maxwidth200" name="extrarow-societe_phone_extension" id="extrarow-societe_phone_extension" value="'.dol_escape_htmltag($object->array_options["options_phone_extension"]).'">';
			print '</td>';
			print '</tr>';
			...
			if (!empty($socid)) {
				...
				print $form->multiselectarray('roles', $contactType, ['41','60','61','198'], 0, 0, 'minwidth500');
				print '</td></tr>';
			}
			...
			print '<td>';
			print img_picto('', 'object_phoning_fax', 'class="pictofixedwidth"');
			print '<input type="text" name="fax" id="fax" class="maxwidth200" maxlength="80" value="'.(GETPOSTISSET('phone_fax') ? GETPOST('phone_fax', 'alpha') : $object->fax).'"></td>';
